...
PROTOBUF_CONSTEXPR DirtyWindowRequest::DirtyWindowRequest(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.dirty_timestamp_seconds_)*/{}
  , /*decltype(_impl_._dirty_timestamp_seconds_cached_byte_size_)*/{0}
...
const uint32_t TableStruct_greptime_2fv1_2fflow_2fserver_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::greptime::v1::flow::DirtyWindowRequest, _impl_.dirty_timestamp_seconds_),
...
const ::_pbi::DescriptorTable descriptor_table_greptime_2fv1_2fflow_2fserver_2eproto = {
    false, false, 1981, descriptor_table_protodef_greptime_2fv1_2fflow_2fserver_2eproto,
...
DirtyWindowRequest::DirtyWindowRequest(const DirtyWindowRequest& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.dirty_timestamp_seconds_){from._impl_.dirty_timestamp_seconds_}
    , /*decltype(_impl_._dirty_timestamp_seconds_cached_byte_size_)*/{0}
...
inline void DirtyWindowRequest::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.dirty_timestamp_seconds_){arena}
    , /*decltype(_impl_._dirty_timestamp_seconds_cached_byte_size_)*/{0}
    , decltype(_impl_.table_id_){0u}
    , /*decltype(_impl_._cached_size_)*/{}
  };
...
inline void DirtyWindowRequest::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.dirty_timestamp_seconds_.~RepeatedField();
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedInt64Parser(_internal_mutable_dirty_timestamp_seconds(), ptr, ctx);
          CHK_(ptr);
        } else if (static_cast<uint8_t>(tag) == 16) {
          _internal_add_dirty_timestamp_seconds(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* DirtyWindowRequest::_InternalSerialize(
  ...
  // repeated int64 dirty_timestamp_seconds = 2;
  {
    int byte_size = _impl_._dirty_timestamp_seconds_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
      target = stream->WriteInt64Packed(
          2, _internal_dirty_timestamp_seconds(), byte_size, target);
    }
  }
...
// @@protoc_insertion_point(message_byte_size_start:greptime.v1.flow.DirtyWindowRequest)
  ...
  // repeated int64 dirty_timestamp_seconds = 2;
  {
    size_t data_size = ::_pbi::WireFormatLite::
      Int64Size(this->_impl_.dirty_timestamp_seconds_);
    if (data_size > 0) {
      total_size += 1 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._dirty_timestamp_seconds_cached_byte_size_.store(cached_size,
...
void DirtyWindowRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.dirty_timestamp_seconds_.MergeFrom(from._impl_.dirty_timestamp_seconds_);
...
void DirtyWindowRequest::InternalSwap(DirtyWindowRequest* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.dirty_timestamp_seconds_.InternalSwap(&other->_impl_.dirty_timestamp_seconds_);
