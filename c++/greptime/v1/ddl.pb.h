...
class ModifyJsonSettings;
struct ModifyJsonSettingsDefaultTypeInternal;
extern ModifyJsonSettingsDefaultTypeInternal _ModifyJsonSettings_default_instance_;
class NotifyChannel;
...
class UnpartitionedSource;
struct UnpartitionedSourceDefaultTypeInternal;
extern UnpartitionedSourceDefaultTypeInternal _UnpartitionedSource_default_instance_;
...
template<> ::greptime::v1::ModifyJsonSettings* Arena::CreateMaybeMessage<::greptime::v1::ModifyJsonSettings>(Arena*);
...
class AlterTableExpr final :
 ...
 public:
  ...
  enum : int {
    ...
    kModifyJsonSettingsFieldNumber = 19,
  };
  // string catalog_name = 1;
  void clear_catalog_name();
  const std::string& catalog_name() const;
  ...
  const ::greptime::v1::Repartition& repartition() const;
  PROTOBUF_NODISCARD ::greptime::v1::Repartition* release_repartition();
  ::greptime::v1::Repartition* mutable_repartition();
  void set_allocated_repartition(::greptime::v1::Repartition* repartition);
  private:
  const ::greptime::v1::Repartition& _internal_repartition() const;
  ::greptime::v1::Repartition* _internal_mutable_repartition();
  public:
...
class Repartition final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:greptime.v1.Repartition) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "greptime.v1.Repartition";
  }
  protected:
  ...
  enum : int {
    ...
    kPartitionExprsFieldNumber = 3,
    kUnpartitionedFieldNumber = 4,
  };
  // repeated string from_partition_exprs = 1 [deprecated = true];
  PROTOBUF_DEPRECATED int from_partition_exprs_size() const;
  private:
  int _internal_from_partition_exprs_size() const;
  public:
  PROTOBUF_DEPRECATED void clear_from_partition_exprs();
  PROTOBUF_DEPRECATED const std::string& from_partition_exprs(int index) const;
  PROTOBUF_DEPRECATED std::string* mutable_from_partition_exprs(int index);
  PROTOBUF_DEPRECATED void set_from_partition_exprs(int index, const std::string& value);
  PROTOBUF_DEPRECATED void set_from_partition_exprs(int index, std::string&& value);
  PROTOBUF_DEPRECATED void set_from_partition_exprs(int index, const char* value);
  PROTOBUF_DEPRECATED void set_from_partition_exprs(int index, const char* value, size_t size);
  PROTOBUF_DEPRECATED std::string* add_from_partition_exprs();
  PROTOBUF_DEPRECATED void add_from_partition_exprs(const std::string& value);
  PROTOBUF_DEPRECATED void add_from_partition_exprs(std::string&& value);
  PROTOBUF_DEPRECATED void add_from_partition_exprs(const char* value);
  PROTOBUF_DEPRECATED void add_from_partition_exprs(const char* value, size_t size);
  PROTOBUF_DEPRECATED const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& from_partition_exprs() const;
  PROTOBUF_DEPRECATED ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_from_partition_exprs();
  private:
  const std::string& _internal_from_partition_exprs(int index) const;
  std::string* _internal_add_from_partition_exprs();
  public:

  // repeated string into_partition_exprs = 2;
  int into_partition_exprs_size() const;
  private:
  int _internal_into_partition_exprs_size() const;
  public:
  void clear_into_partition_exprs();
  const std::string& into_partition_exprs(int index) const;
  std::string* mutable_into_partition_exprs(int index);
  void set_into_partition_exprs(int index, const std::string& value);
  void set_into_partition_exprs(int index, std::string&& value);
  void set_into_partition_exprs(int index, const char* value);
  void set_into_partition_exprs(int index, const char* value, size_t size);
  std::string* add_into_partition_exprs();
  void add_into_partition_exprs(const std::string& value);
  void add_into_partition_exprs(std::string&& value);
  void add_into_partition_exprs(const char* value);
  void add_into_partition_exprs(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& into_partition_exprs() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_into_partition_exprs();
  private:
  const std::string& _internal_into_partition_exprs(int index) const;
  ...
  private:
  bool _internal_has_unpartitioned() const;
  public:
  void clear_unpartitioned();
  const ::greptime::v1::UnpartitionedSource& unpartitioned() const;
  PROTOBUF_NODISCARD ::greptime::v1::UnpartitionedSource* release_unpartitioned();
  ::greptime::v1::UnpartitionedSource* mutable_unpartitioned();
  void set_allocated_unpartitioned(::greptime::v1::UnpartitionedSource* unpartitioned);
  private:
  const ::greptime::v1::UnpartitionedSource& _internal_unpartitioned() const;
  ::greptime::v1::UnpartitionedSource* _internal_mutable_unpartitioned();
  public:
  void unsafe_arena_set_allocated_unpartitioned(
      ::greptime::v1::UnpartitionedSource* unpartitioned);
  ::greptime::v1::UnpartitionedSource* unsafe_arena_release_unpartitioned();
...
class PartitionedSource final :
 ...
 public:
  ...
  public:
  void clear_exprs();
  const std::string& exprs(int index) const;
  std::string* mutable_exprs(int index);
  void set_exprs(int index, const std::string& value);
  void set_exprs(int index, std::string&& value);
  void set_exprs(int index, const char* value);
  void set_exprs(int index, const char* value, size_t size);
  std::string* add_exprs();
  void add_exprs(const std::string& value);
  void add_exprs(std::string&& value);
  void add_exprs(const char* value);
  void add_exprs(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& exprs() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_exprs();
  private:
  const std::string& _internal_exprs(int index) const;
...
class UnpartitionedSource final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:greptime.v1.UnpartitionedSource) */ {
 public:
  inline UnpartitionedSource() : UnpartitionedSource(nullptr) {}
  ~UnpartitionedSource() override;
  explicit PROTOBUF_CONSTEXPR UnpartitionedSource(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  UnpartitionedSource(const UnpartitionedSource& from);
  UnpartitionedSource(UnpartitionedSource&& from) noexcept
    : UnpartitionedSource() {
    *this = ::std::move(from);
  }

  inline UnpartitionedSource& operator=(const UnpartitionedSource& from) {
    CopyFrom(from);
    return *this;
  }
  inline UnpartitionedSource& operator=(UnpartitionedSource&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const UnpartitionedSource& default_instance() {
    return *internal_default_instance();
  }
  static inline const UnpartitionedSource* internal_default_instance() {
    return reinterpret_cast<const UnpartitionedSource*>(
  ...
  inline void Swap(UnpartitionedSource* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(UnpartitionedSource* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  UnpartitionedSource* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<UnpartitionedSource>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const UnpartitionedSource& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const UnpartitionedSource& from) {
    UnpartitionedSource::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(UnpartitionedSource* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "greptime.v1.UnpartitionedSource";
  }
  protected:
  explicit UnpartitionedSource(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kPartitionColumnsFieldNumber = 1,
  };
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& partition_columns() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_partition_columns();
  private:
  const std::string& _internal_partition_columns(int index) const;
  std::string* _internal_add_partition_columns();
  public:

  // @@protoc_insertion_point(class_scope:greptime.v1.UnpartitionedSource)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> partition_columns_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_greptime_2fv1_2fddl_2eproto;
...
class ModifyJsonSettings final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:greptime.v1.ModifyJsonSettings) */ {
 public:
  inline ModifyJsonSettings() : ModifyJsonSettings(nullptr) {}
  ~ModifyJsonSettings() override;
  explicit PROTOBUF_CONSTEXPR ModifyJsonSettings(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ModifyJsonSettings(const ModifyJsonSettings& from);
  ModifyJsonSettings(ModifyJsonSettings&& from) noexcept
    : ModifyJsonSettings() {
    *this = ::std::move(from);
  }

  inline ModifyJsonSettings& operator=(const ModifyJsonSettings& from) {
    CopyFrom(from);
    return *this;
  }
  inline ModifyJsonSettings& operator=(ModifyJsonSettings&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ModifyJsonSettings& default_instance() {
    return *internal_default_instance();
  }
  static inline const ModifyJsonSettings* internal_default_instance() {
    return reinterpret_cast<const ModifyJsonSettings*>(
               &_ModifyJsonSettings_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    32;

  friend void swap(ModifyJsonSettings& a, ModifyJsonSettings& b) {
    a.Swap(&b);
  }
  inline void Swap(ModifyJsonSettings* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ModifyJsonSettings* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ModifyJsonSettings* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ModifyJsonSettings>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ModifyJsonSettings& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ModifyJsonSettings& from) {
    ModifyJsonSettings::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ModifyJsonSettings* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "greptime.v1.ModifyJsonSettings";
  }
  protected:
  explicit ModifyJsonSettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:greptime.v1.ModifyJsonSettings)
 private:
  class _Internal;
...
// .greptime.v1.Repartition repartition = 18;
inline bool AlterTableExpr::_internal_has_repartition() const {
  return kind_case() == kRepartition;
}
inline bool AlterTableExpr::has_repartition() const {
  return _internal_has_repartition();
}
inline void AlterTableExpr::set_has_repartition() {
  _impl_._oneof_case_[0] = kRepartition;
}
inline void AlterTableExpr::clear_repartition() {
...
inline ::greptime::v1::Repartition* AlterTableExpr::release_repartition() {
  // @@protoc_insertion_point(field_release:greptime.v1.AlterTableExpr.repartition)
  if (_internal_has_repartition()) {
    clear_has_kind();
    ::greptime::v1::Repartition* temp = _impl_.kind_.repartition_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.kind_.repartition_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::greptime::v1::Repartition& AlterTableExpr::_internal_repartition() const {
  return _internal_has_repartition()
      ? *_impl_.kind_.repartition_
      : reinterpret_cast< ::greptime::v1::Repartition&>(::greptime::v1::_Repartition_default_instance_);
}
inline const ::greptime::v1::Repartition& AlterTableExpr::repartition() const {
  // @@protoc_insertion_point(field_get:greptime.v1.AlterTableExpr.repartition)
  return _internal_repartition();
}
inline ::greptime::v1::Repartition* AlterTableExpr::unsafe_arena_release_repartition() {
  // @@protoc_insertion_point(field_unsafe_arena_release:greptime.v1.AlterTableExpr.repartition)
  if (_internal_has_repartition()) {
    clear_has_kind();
    ::greptime::v1::Repartition* temp = _impl_.kind_.repartition_;
    _impl_.kind_.repartition_ = nullptr;
...
inline void AlterTableExpr::unsafe_arena_set_allocated_repartition(::greptime::v1::Repartition* repartition) {
  clear_kind();
  if (repartition) {
    set_has_repartition();
    _impl_.kind_.repartition_ = repartition;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:greptime.v1.AlterTableExpr.repartition)
}
inline ::greptime::v1::Repartition* AlterTableExpr::_internal_mutable_repartition() {
  if (!_internal_has_repartition()) {
    clear_kind();
    set_has_repartition();
    _impl_.kind_.repartition_ = CreateMaybeMessage< ::greptime::v1::Repartition >(GetArenaForAllocation());
  }
  return _impl_.kind_.repartition_;
}
inline ::greptime::v1::Repartition* AlterTableExpr::mutable_repartition() {
  ::greptime::v1::Repartition* _msg = _internal_mutable_repartition();
  // @@protoc_insertion_point(field_mutable:greptime.v1.AlterTableExpr.repartition)
  return _msg;
}

// .greptime.v1.ModifyJsonSettings modify_json_settings = 19;
inline bool AlterTableExpr::_internal_has_modify_json_settings() const {
  return kind_case() == kModifyJsonSettings;
}
inline bool AlterTableExpr::has_modify_json_settings() const {
  return _internal_has_modify_json_settings();
}
inline void AlterTableExpr::set_has_modify_json_settings() {
  _impl_._oneof_case_[0] = kModifyJsonSettings;
}
inline void AlterTableExpr::clear_modify_json_settings() {
...
inline ::greptime::v1::ModifyJsonSettings* AlterTableExpr::release_modify_json_settings() {
  // @@protoc_insertion_point(field_release:greptime.v1.AlterTableExpr.modify_json_settings)
  if (_internal_has_modify_json_settings()) {
    clear_has_kind();
...
inline const ::greptime::v1::ModifyJsonSettings& AlterTableExpr::_internal_modify_json_settings() const {
  return _internal_has_modify_json_settings()
...
inline const ::greptime::v1::ModifyJsonSettings& AlterTableExpr::modify_json_settings() const {
  // @@protoc_insertion_point(field_get:greptime.v1.AlterTableExpr.modify_json_settings)
  return _internal_modify_json_settings();
}
inline ::greptime::v1::ModifyJsonSettings* AlterTableExpr::unsafe_arena_release_modify_json_settings() {
  // @@protoc_insertion_point(field_unsafe_arena_release:greptime.v1.AlterTableExpr.modify_json_settings)
  if (_internal_has_modify_json_settings()) {
    clear_has_kind();
    ::greptime::v1::ModifyJsonSettings* temp = _impl_.kind_.modify_json_settings_;
    _impl_.kind_.modify_json_settings_ = nullptr;
...
inline void AlterTableExpr::unsafe_arena_set_allocated_modify_json_settings(::greptime::v1::ModifyJsonSettings* modify_json_settings) {
  clear_kind();
  if (modify_json_settings) {
    set_has_modify_json_settings();
    _impl_.kind_.modify_json_settings_ = modify_json_settings;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:greptime.v1.AlterTableExpr.modify_json_settings)
}
inline ::greptime::v1::ModifyJsonSettings* AlterTableExpr::_internal_mutable_modify_json_settings() {
  if (!_internal_has_modify_json_settings()) {
    clear_kind();
    set_has_modify_json_settings();
...
inline ::greptime::v1::ModifyJsonSettings* AlterTableExpr::mutable_modify_json_settings() {
  ::greptime::v1::ModifyJsonSettings* _msg = _internal_mutable_modify_json_settings();
  // @@protoc_insertion_point(field_mutable:greptime.v1.AlterTableExpr.modify_json_settings)
  return _msg;
}
...
// repeated string from_partition_exprs = 1 [deprecated = true];
inline int Repartition::_internal_from_partition_exprs_size() const {
  return _impl_.from_partition_exprs_.size();
}
inline int Repartition::from_partition_exprs_size() const {
  return _internal_from_partition_exprs_size();
}
inline void Repartition::clear_from_partition_exprs() {
  _impl_.from_partition_exprs_.Clear();
}
inline std::string* Repartition::add_from_partition_exprs() {
  std::string* _s = _internal_add_from_partition_exprs();
  // @@protoc_insertion_point(field_add_mutable:greptime.v1.Repartition.from_partition_exprs)
  return _s;
}
inline const std::string& Repartition::_internal_from_partition_exprs(int index) const {
  return _impl_.from_partition_exprs_.Get(index);
}
inline const std::string& Repartition::from_partition_exprs(int index) const {
  // @@protoc_insertion_point(field_get:greptime.v1.Repartition.from_partition_exprs)
  return _internal_from_partition_exprs(index);
}
inline std::string* Repartition::mutable_from_partition_exprs(int index) {
  // @@protoc_insertion_point(field_mutable:greptime.v1.Repartition.from_partition_exprs)
  return _impl_.from_partition_exprs_.Mutable(index);
}
inline void Repartition::set_from_partition_exprs(int index, const std::string& value) {
  _impl_.from_partition_exprs_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:greptime.v1.Repartition.from_partition_exprs)
}
inline void Repartition::set_from_partition_exprs(int index, std::string&& value) {
  _impl_.from_partition_exprs_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:greptime.v1.Repartition.from_partition_exprs)
}
inline void Repartition::set_from_partition_exprs(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.from_partition_exprs_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:greptime.v1.Repartition.from_partition_exprs)
}
inline void Repartition::set_from_partition_exprs(int index, const char* value, size_t size) {
  _impl_.from_partition_exprs_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:greptime.v1.Repartition.from_partition_exprs)
}
inline std::string* Repartition::_internal_add_from_partition_exprs() {
  return _impl_.from_partition_exprs_.Add();
}
inline void Repartition::add_from_partition_exprs(const std::string& value) {
  _impl_.from_partition_exprs_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:greptime.v1.Repartition.from_partition_exprs)
}
inline void Repartition::add_from_partition_exprs(std::string&& value) {
  _impl_.from_partition_exprs_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:greptime.v1.Repartition.from_partition_exprs)
}
inline void Repartition::add_from_partition_exprs(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.from_partition_exprs_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:greptime.v1.Repartition.from_partition_exprs)
}
inline void Repartition::add_from_partition_exprs(const char* value, size_t size) {
  _impl_.from_partition_exprs_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:greptime.v1.Repartition.from_partition_exprs)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Repartition::from_partition_exprs() const {
  // @@protoc_insertion_point(field_list:greptime.v1.Repartition.from_partition_exprs)
  return _impl_.from_partition_exprs_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Repartition::mutable_from_partition_exprs() {
  // @@protoc_insertion_point(field_mutable_list:greptime.v1.Repartition.from_partition_exprs)
  return &_impl_.from_partition_exprs_;
}

// repeated string into_partition_exprs = 2;
inline int Repartition::_internal_into_partition_exprs_size() const {
  return _impl_.into_partition_exprs_.size();
}
inline int Repartition::into_partition_exprs_size() const {
  return _internal_into_partition_exprs_size();
}
inline void Repartition::clear_into_partition_exprs() {
  _impl_.into_partition_exprs_.Clear();
}
inline std::string* Repartition::add_into_partition_exprs() {
  std::string* _s = _internal_add_into_partition_exprs();
  // @@protoc_insertion_point(field_add_mutable:greptime.v1.Repartition.into_partition_exprs)
  return _s;
}
inline const std::string& Repartition::_internal_into_partition_exprs(int index) const {
  return _impl_.into_partition_exprs_.Get(index);
}
inline const std::string& Repartition::into_partition_exprs(int index) const {
  // @@protoc_insertion_point(field_get:greptime.v1.Repartition.into_partition_exprs)
  return _internal_into_partition_exprs(index);
}
inline std::string* Repartition::mutable_into_partition_exprs(int index) {
  // @@protoc_insertion_point(field_mutable:greptime.v1.Repartition.into_partition_exprs)
  return _impl_.into_partition_exprs_.Mutable(index);
}
inline void Repartition::set_into_partition_exprs(int index, const std::string& value) {
  _impl_.into_partition_exprs_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:greptime.v1.Repartition.into_partition_exprs)
}
inline void Repartition::set_into_partition_exprs(int index, std::string&& value) {
  _impl_.into_partition_exprs_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:greptime.v1.Repartition.into_partition_exprs)
}
inline void Repartition::set_into_partition_exprs(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.into_partition_exprs_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:greptime.v1.Repartition.into_partition_exprs)
}
inline void Repartition::set_into_partition_exprs(int index, const char* value, size_t size) {
  _impl_.into_partition_exprs_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:greptime.v1.Repartition.into_partition_exprs)
}
inline std::string* Repartition::_internal_add_into_partition_exprs() {
  return _impl_.into_partition_exprs_.Add();
}
inline void Repartition::add_into_partition_exprs(const std::string& value) {
  _impl_.into_partition_exprs_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:greptime.v1.Repartition.into_partition_exprs)
}
inline void Repartition::add_into_partition_exprs(std::string&& value) {
  _impl_.into_partition_exprs_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:greptime.v1.Repartition.into_partition_exprs)
}
inline void Repartition::add_into_partition_exprs(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.into_partition_exprs_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:greptime.v1.Repartition.into_partition_exprs)
}
inline void Repartition::add_into_partition_exprs(const char* value, size_t size) {
  _impl_.into_partition_exprs_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:greptime.v1.Repartition.into_partition_exprs)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Repartition::into_partition_exprs() const {
  // @@protoc_insertion_point(field_list:greptime.v1.Repartition.into_partition_exprs)
...
inline bool Repartition::has_partition_exprs() const {
  return _internal_has_partition_exprs();
}
inline void Repartition::set_has_partition_exprs() {
  _impl_._oneof_case_[0] = kPartitionExprs;
}
inline void Repartition::clear_partition_exprs() {
...
// .greptime.v1.UnpartitionedSource unpartitioned = 4;
inline bool Repartition::_internal_has_unpartitioned() const {
  return source_case() == kUnpartitioned;
}
inline bool Repartition::has_unpartitioned() const {
  return _internal_has_unpartitioned();
}
inline void Repartition::set_has_unpartitioned() {
  _impl_._oneof_case_[0] = kUnpartitioned;
}
inline void Repartition::clear_unpartitioned() {
...
inline ::greptime::v1::UnpartitionedSource* Repartition::release_unpartitioned() {
  // @@protoc_insertion_point(field_release:greptime.v1.Repartition.unpartitioned)
  if (_internal_has_unpartitioned()) {
    clear_has_source();
    ::greptime::v1::UnpartitionedSource* temp = _impl_.source_.unpartitioned_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.source_.unpartitioned_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::greptime::v1::UnpartitionedSource& Repartition::_internal_unpartitioned() const {
  return _internal_has_unpartitioned()
      ? *_impl_.source_.unpartitioned_
      : reinterpret_cast< ::greptime::v1::UnpartitionedSource&>(::greptime::v1::_UnpartitionedSource_default_instance_);
}
inline const ::greptime::v1::UnpartitionedSource& Repartition::unpartitioned() const {
  // @@protoc_insertion_point(field_get:greptime.v1.Repartition.unpartitioned)
  return _internal_unpartitioned();
}
inline ::greptime::v1::UnpartitionedSource* Repartition::unsafe_arena_release_unpartitioned() {
  // @@protoc_insertion_point(field_unsafe_arena_release:greptime.v1.Repartition.unpartitioned)
  if (_internal_has_unpartitioned()) {
    clear_has_source();
    ::greptime::v1::UnpartitionedSource* temp = _impl_.source_.unpartitioned_;
    _impl_.source_.unpartitioned_ = nullptr;
...
inline void Repartition::unsafe_arena_set_allocated_unpartitioned(::greptime::v1::UnpartitionedSource* unpartitioned) {
  clear_source();
  if (unpartitioned) {
    set_has_unpartitioned();
    _impl_.source_.unpartitioned_ = unpartitioned;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:greptime.v1.Repartition.unpartitioned)
}
inline ::greptime::v1::UnpartitionedSource* Repartition::_internal_mutable_unpartitioned() {
  if (!_internal_has_unpartitioned()) {
    clear_source();
    set_has_unpartitioned();
    _impl_.source_.unpartitioned_ = CreateMaybeMessage< ::greptime::v1::UnpartitionedSource >(GetArenaForAllocation());
  }
  return _impl_.source_.unpartitioned_;
}
inline ::greptime::v1::UnpartitionedSource* Repartition::mutable_unpartitioned() {
  ::greptime::v1::UnpartitionedSource* _msg = _internal_mutable_unpartitioned();
  // @@protoc_insertion_point(field_mutable:greptime.v1.Repartition.unpartitioned)
  return _msg;
}

inline bool Repartition::has_source() const {
  return source_case() != SOURCE_NOT_SET;
}
inline void Repartition::clear_has_source() {
  _impl_._oneof_case_[0] = SOURCE_NOT_SET;
}
inline Repartition::SourceCase Repartition::source_case() const {
  return Repartition::SourceCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// repeated string partition_columns = 1;
inline int UnpartitionedSource::_internal_partition_columns_size() const {
  return _impl_.partition_columns_.size();
}
inline int UnpartitionedSource::partition_columns_size() const {
  return _internal_partition_columns_size();
}
inline void UnpartitionedSource::clear_partition_columns() {
  _impl_.partition_columns_.Clear();
}
inline std::string* UnpartitionedSource::add_partition_columns() {
  std::string* _s = _internal_add_partition_columns();
  // @@protoc_insertion_point(field_add_mutable:greptime.v1.UnpartitionedSource.partition_columns)
  return _s;
}
inline const std::string& UnpartitionedSource::_internal_partition_columns(int index) const {
  return _impl_.partition_columns_.Get(index);
}
inline const std::string& UnpartitionedSource::partition_columns(int index) const {
  // @@protoc_insertion_point(field_get:greptime.v1.UnpartitionedSource.partition_columns)
  return _internal_partition_columns(index);
}
inline std::string* UnpartitionedSource::mutable_partition_columns(int index) {
  // @@protoc_insertion_point(field_mutable:greptime.v1.UnpartitionedSource.partition_columns)
  return _impl_.partition_columns_.Mutable(index);
}
inline void UnpartitionedSource::set_partition_columns(int index, const std::string& value) {
  _impl_.partition_columns_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:greptime.v1.UnpartitionedSource.partition_columns)
}
inline void UnpartitionedSource::set_partition_columns(int index, std::string&& value) {
  _impl_.partition_columns_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:greptime.v1.UnpartitionedSource.partition_columns)
}
inline void UnpartitionedSource::set_partition_columns(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.partition_columns_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:greptime.v1.UnpartitionedSource.partition_columns)
}
inline void UnpartitionedSource::set_partition_columns(int index, const char* value, size_t size) {
  _impl_.partition_columns_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:greptime.v1.UnpartitionedSource.partition_columns)
}
inline std::string* UnpartitionedSource::_internal_add_partition_columns() {
  return _impl_.partition_columns_.Add();
}
inline void UnpartitionedSource::add_partition_columns(const std::string& value) {
  _impl_.partition_columns_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:greptime.v1.UnpartitionedSource.partition_columns)
}
inline void UnpartitionedSource::add_partition_columns(std::string&& value) {
  _impl_.partition_columns_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:greptime.v1.UnpartitionedSource.partition_columns)
}
inline void UnpartitionedSource::add_partition_columns(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.partition_columns_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:greptime.v1.UnpartitionedSource.partition_columns)
}
inline void UnpartitionedSource::add_partition_columns(const char* value, size_t size) {
  _impl_.partition_columns_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:greptime.v1.UnpartitionedSource.partition_columns)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
UnpartitionedSource::partition_columns() const {
  // @@protoc_insertion_point(field_list:greptime.v1.UnpartitionedSource.partition_columns)
  return _impl_.partition_columns_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
UnpartitionedSource::mutable_partition_columns() {
  // @@protoc_insertion_point(field_mutable_list:greptime.v1.UnpartitionedSource.partition_columns)
  return &_impl_.partition_columns_;
}
...
// string column_name = 1;
inline void ModifyJsonSettings::clear_column_name() {
  _impl_.column_name_.ClearToEmpty();
}
inline const std::string& ModifyJsonSettings::column_name() const {
  // @@protoc_insertion_point(field_get:greptime.v1.ModifyJsonSettings.column_name)
  return _internal_column_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ModifyJsonSettings::set_column_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.column_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:greptime.v1.ModifyJsonSettings.column_name)
}
inline std::string* ModifyJsonSettings::mutable_column_name() {
  std::string* _s = _internal_mutable_column_name();
  // @@protoc_insertion_point(field_mutable:greptime.v1.ModifyJsonSettings.column_name)
  return _s;
}
inline const std::string& ModifyJsonSettings::_internal_column_name() const {
  return _impl_.column_name_.Get();
}
inline void ModifyJsonSettings::_internal_set_column_name(const std::string& value) {
  
  _impl_.column_name_.Set(value, GetArenaForAllocation());
}
inline std::string* ModifyJsonSettings::_internal_mutable_column_name() {
  
  return _impl_.column_name_.Mutable(GetArenaForAllocation());
}
inline std::string* ModifyJsonSettings::release_column_name() {
  // @@protoc_insertion_point(field_release:greptime.v1.ModifyJsonSettings.column_name)
  return _impl_.column_name_.Release();
}
inline void ModifyJsonSettings::set_allocated_column_name(std::string* column_name) {
  if (column_name != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:greptime.v1.ModifyJsonSettings.column_name)
}

// .greptime.v1.ColumnOptions options = 2;
inline bool ModifyJsonSettings::_internal_has_options() const {
  return this != internal_default_instance() && _impl_.options_ != nullptr;
}
inline bool ModifyJsonSettings::has_options() const {
  return _internal_has_options();
}
inline const ::greptime::v1::ColumnOptions& ModifyJsonSettings::_internal_options() const {
...
inline const ::greptime::v1::ColumnOptions& ModifyJsonSettings::options() const {
  // @@protoc_insertion_point(field_get:greptime.v1.ModifyJsonSettings.options)
  return _internal_options();
}
inline void ModifyJsonSettings::unsafe_arena_set_allocated_options(
    ::greptime::v1::ColumnOptions* options) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:greptime.v1.ModifyJsonSettings.options)
}
inline ::greptime::v1::ColumnOptions* ModifyJsonSettings::release_options() {
...
inline ::greptime::v1::ColumnOptions* ModifyJsonSettings::unsafe_arena_release_options() {
  // @@protoc_insertion_point(field_release:greptime.v1.ModifyJsonSettings.options)
  
  ::greptime::v1::ColumnOptions* temp = _impl_.options_;
  _impl_.options_ = nullptr;
  return temp;
}
inline ::greptime::v1::ColumnOptions* ModifyJsonSettings::_internal_mutable_options() {
...
inline ::greptime::v1::ColumnOptions* ModifyJsonSettings::mutable_options() {
  ::greptime::v1::ColumnOptions* _msg = _internal_mutable_options();
  // @@protoc_insertion_point(field_mutable:greptime.v1.ModifyJsonSettings.options)
  return _msg;
}
inline void ModifyJsonSettings::set_allocated_options(::greptime::v1::ColumnOptions* options) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.options_);
  }
  ...
  _impl_.options_ = options;
  // @@protoc_insertion_point(field_set_allocated:greptime.v1.ModifyJsonSettings.options)
}
