...
class UnsetIndex final :
 ...
 public:
  ...
  enum : int {
    kUnsetFulltextFieldNumber = 1,
    kUnsetInvertedFieldNumber = 2,
  };
  // .greptime.v1.UnsetFulltext unset_fulltext = 1;
  bool has_unset_fulltext() const;
  private:
  bool _internal_has_unset_fulltext() const;
  public:
  void clear_unset_fulltext();
  const ::greptime::v1::UnsetFulltext& unset_fulltext() const;
  PROTOBUF_NODISCARD ::greptime::v1::UnsetFulltext* release_unset_fulltext();
  ::greptime::v1::UnsetFulltext* mutable_unset_fulltext();
  void set_allocated_unset_fulltext(::greptime::v1::UnsetFulltext* unset_fulltext);
  private:
  const ::greptime::v1::UnsetFulltext& _internal_unset_fulltext() const;
  ::greptime::v1::UnsetFulltext* _internal_mutable_unset_fulltext();
  public:
  void unsafe_arena_set_allocated_unset_fulltext(
      ::greptime::v1::UnsetFulltext* unset_fulltext);
  ::greptime::v1::UnsetFulltext* unsafe_arena_release_unset_fulltext();

  // .greptime.v1.UnsetInverted unset_inverted = 2;
  bool has_unset_inverted() const;
  private:
  bool _internal_has_unset_inverted() const;
  public:
  void clear_unset_inverted();
  const ::greptime::v1::UnsetInverted& unset_inverted() const;
  PROTOBUF_NODISCARD ::greptime::v1::UnsetInverted* release_unset_inverted();
  ::greptime::v1::UnsetInverted* mutable_unset_inverted();
  void set_allocated_unset_inverted(::greptime::v1::UnsetInverted* unset_inverted);
  private:
  const ::greptime::v1::UnsetInverted& _internal_unset_inverted() const;
  ::greptime::v1::UnsetInverted* _internal_mutable_unset_inverted();
  public:
  void unsafe_arena_set_allocated_unset_inverted(
      ::greptime::v1::UnsetInverted* unset_inverted);
  ::greptime::v1::UnsetInverted* unsafe_arena_release_unset_inverted();
 ...
 private:
  class _Internal;
  void set_has_unset_fulltext();
  void set_has_unset_inverted();
  ...
  struct Impl_ {
    union OptionsUnion {
      constexpr OptionsUnion() : _constinit_{} {}
        ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized _constinit_;
      ::greptime::v1::UnsetFulltext* unset_fulltext_;
      ::greptime::v1::UnsetInverted* unset_inverted_;
    } options_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    uint32_t _oneof_case_[1];
...
// .greptime.v1.UnsetFulltext unset_fulltext = 1;
inline bool UnsetIndex::_internal_has_unset_fulltext() const {
  return options_case() == kUnsetFulltext;
}
inline bool UnsetIndex::has_unset_fulltext() const {
  return _internal_has_unset_fulltext();
}
inline void UnsetIndex::set_has_unset_fulltext() {
  _impl_._oneof_case_[0] = kUnsetFulltext;
}
inline void UnsetIndex::clear_unset_fulltext() {
...
inline ::greptime::v1::UnsetFulltext* UnsetIndex::release_unset_fulltext() {
  // @@protoc_insertion_point(field_release:greptime.v1.UnsetIndex.unset_fulltext)
  if (_internal_has_unset_fulltext()) {
    clear_has_options();
    ::greptime::v1::UnsetFulltext* temp = _impl_.options_.unset_fulltext_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.options_.unset_fulltext_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::greptime::v1::UnsetFulltext& UnsetIndex::_internal_unset_fulltext() const {
  return _internal_has_unset_fulltext()
      ? *_impl_.options_.unset_fulltext_
      : reinterpret_cast< ::greptime::v1::UnsetFulltext&>(::greptime::v1::_UnsetFulltext_default_instance_);
}
inline const ::greptime::v1::UnsetFulltext& UnsetIndex::unset_fulltext() const {
  // @@protoc_insertion_point(field_get:greptime.v1.UnsetIndex.unset_fulltext)
  return _internal_unset_fulltext();
}
inline ::greptime::v1::UnsetFulltext* UnsetIndex::unsafe_arena_release_unset_fulltext() {
  // @@protoc_insertion_point(field_unsafe_arena_release:greptime.v1.UnsetIndex.unset_fulltext)
  if (_internal_has_unset_fulltext()) {
    clear_has_options();
    ::greptime::v1::UnsetFulltext* temp = _impl_.options_.unset_fulltext_;
    _impl_.options_.unset_fulltext_ = nullptr;
...
inline void UnsetIndex::unsafe_arena_set_allocated_unset_fulltext(::greptime::v1::UnsetFulltext* unset_fulltext) {
  clear_options();
  if (unset_fulltext) {
    set_has_unset_fulltext();
    _impl_.options_.unset_fulltext_ = unset_fulltext;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:greptime.v1.UnsetIndex.unset_fulltext)
}
inline ::greptime::v1::UnsetFulltext* UnsetIndex::_internal_mutable_unset_fulltext() {
  if (!_internal_has_unset_fulltext()) {
    clear_options();
    set_has_unset_fulltext();
    _impl_.options_.unset_fulltext_ = CreateMaybeMessage< ::greptime::v1::UnsetFulltext >(GetArenaForAllocation());
  }
  return _impl_.options_.unset_fulltext_;
}
inline ::greptime::v1::UnsetFulltext* UnsetIndex::mutable_unset_fulltext() {
  ::greptime::v1::UnsetFulltext* _msg = _internal_mutable_unset_fulltext();
  // @@protoc_insertion_point(field_mutable:greptime.v1.UnsetIndex.unset_fulltext)
  return _msg;
}

// .greptime.v1.UnsetInverted unset_inverted = 2;
inline bool UnsetIndex::_internal_has_unset_inverted() const {
  return options_case() == kUnsetInverted;
}
inline bool UnsetIndex::has_unset_inverted() const {
  return _internal_has_unset_inverted();
}
inline void UnsetIndex::set_has_unset_inverted() {
  _impl_._oneof_case_[0] = kUnsetInverted;
}
inline void UnsetIndex::clear_unset_inverted() {
...
inline ::greptime::v1::UnsetInverted* UnsetIndex::release_unset_inverted() {
  // @@protoc_insertion_point(field_release:greptime.v1.UnsetIndex.unset_inverted)
  if (_internal_has_unset_inverted()) {
    clear_has_options();
    ::greptime::v1::UnsetInverted* temp = _impl_.options_.unset_inverted_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.options_.unset_inverted_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::greptime::v1::UnsetInverted& UnsetIndex::_internal_unset_inverted() const {
  return _internal_has_unset_inverted()
      ? *_impl_.options_.unset_inverted_
      : reinterpret_cast< ::greptime::v1::UnsetInverted&>(::greptime::v1::_UnsetInverted_default_instance_);
}
inline const ::greptime::v1::UnsetInverted& UnsetIndex::unset_inverted() const {
  // @@protoc_insertion_point(field_get:greptime.v1.UnsetIndex.unset_inverted)
  return _internal_unset_inverted();
}
inline ::greptime::v1::UnsetInverted* UnsetIndex::unsafe_arena_release_unset_inverted() {
  // @@protoc_insertion_point(field_unsafe_arena_release:greptime.v1.UnsetIndex.unset_inverted)
  if (_internal_has_unset_inverted()) {
    clear_has_options();
    ::greptime::v1::UnsetInverted* temp = _impl_.options_.unset_inverted_;
    _impl_.options_.unset_inverted_ = nullptr;
...
inline void UnsetIndex::unsafe_arena_set_allocated_unset_inverted(::greptime::v1::UnsetInverted* unset_inverted) {
  clear_options();
  if (unset_inverted) {
    set_has_unset_inverted();
    _impl_.options_.unset_inverted_ = unset_inverted;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:greptime.v1.UnsetIndex.unset_inverted)
}
inline ::greptime::v1::UnsetInverted* UnsetIndex::_internal_mutable_unset_inverted() {
  if (!_internal_has_unset_inverted()) {
    clear_options();
    set_has_unset_inverted();
    _impl_.options_.unset_inverted_ = CreateMaybeMessage< ::greptime::v1::UnsetInverted >(GetArenaForAllocation());
  }
  return _impl_.options_.unset_inverted_;
}
inline ::greptime::v1::UnsetInverted* UnsetIndex::mutable_unset_inverted() {
  ::greptime::v1::UnsetInverted* _msg = _internal_mutable_unset_inverted();
  // @@protoc_insertion_point(field_mutable:greptime.v1.UnsetIndex.unset_inverted)
  return _msg;
}
