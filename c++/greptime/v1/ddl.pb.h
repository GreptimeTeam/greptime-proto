...
class FlowPartitionId;
struct FlowPartitionIdDefaultTypeInternal;
extern FlowPartitionIdDefaultTypeInternal _FlowPartitionId_default_instance_;
class RenameTable;
...
template<> ::greptime::v1::FlowPartitionId* Arena::CreateMaybeMessage<::greptime::v1::FlowPartitionId>(Arena*);
...
class FlowPartitionId final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:greptime.v1.FlowPartitionId) */ {
 public:
  inline FlowPartitionId() : FlowPartitionId(nullptr) {}
  ~FlowPartitionId() override;
  explicit PROTOBUF_CONSTEXPR FlowPartitionId(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  FlowPartitionId(const FlowPartitionId& from);
  FlowPartitionId(FlowPartitionId&& from) noexcept
    : FlowPartitionId() {
    *this = ::std::move(from);
  }

  inline FlowPartitionId& operator=(const FlowPartitionId& from) {
    CopyFrom(from);
    return *this;
  }
  inline FlowPartitionId& operator=(FlowPartitionId&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const FlowPartitionId& default_instance() {
    return *internal_default_instance();
  }
  static inline const FlowPartitionId* internal_default_instance() {
    return reinterpret_cast<const FlowPartitionId*>(
               &_FlowPartitionId_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    23;

  friend void swap(FlowPartitionId& a, FlowPartitionId& b) {
    a.Swap(&b);
  }
  inline void Swap(FlowPartitionId* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(FlowPartitionId* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  FlowPartitionId* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<FlowPartitionId>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const FlowPartitionId& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const FlowPartitionId& from) {
    FlowPartitionId::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(FlowPartitionId* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "greptime.v1.FlowPartitionId";
  }
  protected:
  explicit FlowPartitionId(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
// uint32 id = 1;
inline void FlowPartitionId::clear_id() {
  _impl_.id_ = 0u;
}
inline uint32_t FlowPartitionId::_internal_id() const {
  return _impl_.id_;
}
inline uint32_t FlowPartitionId::id() const {
  // @@protoc_insertion_point(field_get:greptime.v1.FlowPartitionId.id)
  return _internal_id();
}
inline void FlowPartitionId::_internal_set_id(uint32_t value) {
  
  _impl_.id_ = value;
}
inline void FlowPartitionId::set_id(uint32_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:greptime.v1.FlowPartitionId.id)
}
