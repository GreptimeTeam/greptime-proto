...
PROTOBUF_CONSTEXPR ModifyColumns::ModifyColumns(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.modify_columns_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct ModifyColumnsDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ModifyColumnsDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ModifyColumnsDefaultTypeInternal() {}
  union {
    ModifyColumns _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ModifyColumnsDefaultTypeInternal _ModifyColumns_default_instance_;
...
struct ModifyColumnDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ModifyColumnDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ModifyColumnDefaultTypeInternal() {}
  union {
    ModifyColumn _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ModifyColumnDefaultTypeInternal _ModifyColumn_default_instance_;
...
const uint32_t TableStruct_greptime_2fv1_2fregion_2fserver_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::greptime::v1::region::ModifyColumns, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::greptime::v1::region::ModifyColumns, _impl_.modify_columns_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::greptime::v1::region::ModifyColumn, _impl_.column_def_),
  PROTOBUF_FIELD_OFFSET(::greptime::v1::region::ModifyColumn, _impl_.target_type_),
  PROTOBUF_FIELD_OFFSET(::greptime::v1::region::ModifyColumn, _impl_.target_type_extension_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 39, 47, -1, sizeof(::greptime::v1::region::RegionResponse_ExtensionEntry_DoNotUse)},
  { 49, -1, -1, sizeof(::greptime::v1::region::RegionResponse)},
  { 58, -1, -1, sizeof(::greptime::v1::region::InsertRequests)},
  { 65, -1, -1, sizeof(::greptime::v1::region::DeleteRequests)},
  { 72, -1, -1, sizeof(::greptime::v1::region::InsertRequest)},
  { 80, -1, -1, sizeof(::greptime::v1::region::DeleteRequest)},
  { 88, -1, -1, sizeof(::greptime::v1::region::QueryRequest)},
  { 97, -1, -1, sizeof(::greptime::v1::region::CreateRequests)},
  { 104, 112, -1, sizeof(::greptime::v1::region::CreateRequest_OptionsEntry_DoNotUse)},
  { 114, -1, -1, sizeof(::greptime::v1::region::CreateRequest)},
  { 126, -1, -1, sizeof(::greptime::v1::region::DropRequests)},
  { 133, -1, -1, sizeof(::greptime::v1::region::DropRequest)},
  { 140, 148, -1, sizeof(::greptime::v1::region::OpenRequest_OptionsEntry_DoNotUse)},
  { 150, -1, -1, sizeof(::greptime::v1::region::OpenRequest)},
  { 160, -1, -1, sizeof(::greptime::v1::region::CloseRequest)},
  { 167, -1, -1, sizeof(::greptime::v1::region::AlterRequests)},
  { 174, -1, -1, sizeof(::greptime::v1::region::AlterRequest)},
  { 186, -1, -1, sizeof(::greptime::v1::region::AddColumns)},
  { 193, -1, -1, sizeof(::greptime::v1::region::DropColumns)},
  ...
  { 224, -1, -1, sizeof(::greptime::v1::region::DropColumn)},
  { 231, -1, -1, sizeof(::greptime::v1::region::FlushRequest)},
  { 238, -1, -1, sizeof(::greptime::v1::region::CompactRequest)},
  { 245, -1, -1, sizeof(::greptime::v1::region::TruncateRequest)},
  { 252, -1, -1, sizeof(::greptime::v1::region::RegionColumnDef)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::greptime::v1::region::_ModifyColumns_default_instance_._instance,
  &::greptime::v1::region::_AddColumn_default_instance_._instance,
  &::greptime::v1::region::_ModifyColumn_default_instance_._instance,
...
const ::_pbi::DescriptorTable descriptor_table_greptime_2fv1_2fregion_2fserver_2eproto = {
    false, false, 3543, descriptor_table_protodef_greptime_2fv1_2fregion_2fserver_2eproto,
...
class AlterRequest::_Internal {
 public:
  ...
  static const ::greptime::v1::region::ModifyColumns& modify_columns(const AlterRequest* msg);
};
...
const ::greptime::v1::region::ModifyColumns&
AlterRequest::_Internal::modify_columns(const AlterRequest* msg) {
  return *msg->_impl_.kind_.modify_columns_;
}
...
void AlterRequest::set_allocated_modify_columns(::greptime::v1::region::ModifyColumns* modify_columns) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  clear_kind();
  if (modify_columns) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(modify_columns);
    if (message_arena != submessage_arena) {
      modify_columns = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, modify_columns, submessage_arena);
    }
    set_has_modify_columns();
    _impl_.kind_.modify_columns_ = modify_columns;
  }
  // @@protoc_insertion_point(field_set_allocated:greptime.v1.region.AlterRequest.modify_columns)
}
...
AlterRequest::AlterRequest(const AlterRequest& from)
  ...
  switch (from.kind_case()) {
    ...
    case kModifyColumns: {
      _this->_internal_mutable_modify_columns()->::greptime::v1::region::ModifyColumns::MergeFrom(
          from._internal_modify_columns());
      break;
    }
    case KIND_NOT_SET: {
      break;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ptr = ctx->ParseMessage(_internal_mutable_modify_columns(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* AlterRequest::_InternalSerialize(
  ...
  if (_internal_has_modify_columns()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(5, _Internal::modify_columns(this),
        _Internal::modify_columns(this).GetCachedSize(), target, stream);
  }
...
class ModifyColumns::_Internal {
 public:
};

ModifyColumns::ModifyColumns(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:greptime.v1.region.ModifyColumns)
}
ModifyColumns::ModifyColumns(const ModifyColumns& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  ModifyColumns* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.modify_columns_){from._impl_.modify_columns_}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:greptime.v1.region.ModifyColumns)
}

inline void ModifyColumns::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.modify_columns_){arena}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}

ModifyColumns::~ModifyColumns() {
  // @@protoc_insertion_point(destructor:greptime.v1.region.ModifyColumns)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void ModifyColumns::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.modify_columns_.~RepeatedPtrField();
}

void ModifyColumns::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void ModifyColumns::Clear() {
// @@protoc_insertion_point(message_clear_start:greptime.v1.region.ModifyColumns)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* ModifyColumns::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_modify_columns(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<10>(ptr));
        } else
...
uint8_t* ModifyColumns::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:greptime.v1.region.ModifyColumns)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  // repeated .greptime.v1.region.ModifyColumn modify_columns = 1;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_modify_columns_size()); i < n; i++) {
    const auto& repfield = this->_internal_modify_columns(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(1, repfield, repfield.GetCachedSize(), target, stream);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:greptime.v1.region.ModifyColumns)
  return target;
}

size_t ModifyColumns::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:greptime.v1.region.ModifyColumns)
  size_t total_size = 0;
  ...
  // repeated .greptime.v1.region.ModifyColumn modify_columns = 1;
  total_size += 1UL * this->_internal_modify_columns_size();
  for (const auto& msg : this->_impl_.modify_columns_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ModifyColumns::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ModifyColumns::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ModifyColumns::GetClassData() const { return &_class_data_; }


void ModifyColumns::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ModifyColumns*>(&to_msg);
  auto& from = static_cast<const ModifyColumns&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:greptime.v1.region.ModifyColumns)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  _this->_impl_.modify_columns_.MergeFrom(from._impl_.modify_columns_);
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void ModifyColumns::CopyFrom(const ModifyColumns& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:greptime.v1.region.ModifyColumns)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ModifyColumns::IsInitialized() const {
  return true;
}

void ModifyColumns::InternalSwap(ModifyColumns* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.modify_columns_.InternalSwap(&other->_impl_.modify_columns_);
}

::PROTOBUF_NAMESPACE_ID::Metadata ModifyColumns::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_greptime_2fv1_2fregion_2fserver_2eproto_getter, &descriptor_table_greptime_2fv1_2fregion_2fserver_2eproto_once,
...
class ModifyColumn::_Internal {
 public:
  static const ::greptime::v1::ColumnDef& column_def(const ModifyColumn* msg);
  static const ::greptime::v1::ColumnDataTypeExtension& target_type_extension(const ModifyColumn* msg);
};

const ::greptime::v1::ColumnDef&
ModifyColumn::_Internal::column_def(const ModifyColumn* msg) {
  return *msg->_impl_.column_def_;
}
const ::greptime::v1::ColumnDataTypeExtension&
ModifyColumn::_Internal::target_type_extension(const ModifyColumn* msg) {
  return *msg->_impl_.target_type_extension_;
}
void ModifyColumn::clear_column_def() {
  if (GetArenaForAllocation() == nullptr && _impl_.column_def_ != nullptr) {
    delete _impl_.column_def_;
  }
  _impl_.column_def_ = nullptr;
}
void ModifyColumn::clear_target_type_extension() {
...
ModifyColumn::ModifyColumn(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:greptime.v1.region.ModifyColumn)
}
ModifyColumn::ModifyColumn(const ModifyColumn& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
...
inline void ModifyColumn::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
ModifyColumn::~ModifyColumn() {
  // @@protoc_insertion_point(destructor:greptime.v1.region.ModifyColumn)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
const char* ModifyColumn::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* ModifyColumn::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:greptime.v1.region.ModifyColumn)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:greptime.v1.region.ModifyColumn)
  return target;
}

size_t ModifyColumn::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:greptime.v1.region.ModifyColumn)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData ModifyColumn::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    ModifyColumn::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*ModifyColumn::GetClassData() const { return &_class_data_; }


void ModifyColumn::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<ModifyColumn*>(&to_msg);
  auto& from = static_cast<const ModifyColumn&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:greptime.v1.region.ModifyColumn)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void ModifyColumn::CopyFrom(const ModifyColumn& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:greptime.v1.region.ModifyColumn)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool ModifyColumn::IsInitialized() const {
  return true;
}

void ModifyColumn::InternalSwap(ModifyColumn* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ModifyColumn, _impl_.target_type_)
      + sizeof(ModifyColumn::_impl_.target_type_)
      - PROTOBUF_FIELD_OFFSET(ModifyColumn, _impl_.column_def_)>(
          reinterpret_cast<char*>(&_impl_.column_def_),
          reinterpret_cast<char*>(&other->_impl_.column_def_));
}
...
template<> PROTOBUF_NOINLINE ::greptime::v1::region::ModifyColumns*
Arena::CreateMaybeMessage< ::greptime::v1::region::ModifyColumns >(Arena* arena) {
  return Arena::CreateMessageInternal< ::greptime::v1::region::ModifyColumns >(arena);
}
...
template<> PROTOBUF_NOINLINE ::greptime::v1::region::ModifyColumn*
Arena::CreateMaybeMessage< ::greptime::v1::region::ModifyColumn >(Arena* arena) {
  return Arena::CreateMessageInternal< ::greptime::v1::region::ModifyColumn >(arena);
}
