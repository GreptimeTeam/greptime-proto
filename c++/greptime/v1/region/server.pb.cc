...
const ::_pbi::DescriptorTable descriptor_table_greptime_2fv1_2fregion_2fserver_2eproto = {
    false, false, 3584, descriptor_table_protodef_greptime_2fv1_2fregion_2fserver_2eproto,
...
class AlterRequest::_Internal {
 public:
  ...
  static const ::greptime::v1::ChangeTableAttributes& change_table_attributes(const AlterRequest* msg);
};
