...
PROTOBUF_CONSTEXPR MigrateRegionRequest::MigrateRegionRequest(
  ...
  , /*decltype(_impl_.flush_timeout_secs_)*/0u
...
const uint32_t TableStruct_greptime_2fv1_2fmeta_2fregion_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::greptime::v1::meta::MigrateRegionRequest, _impl_.flush_timeout_secs_),
  ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_greptime_2fv1_2fmeta_2fregion_2eproto = {
    false, false, 455, descriptor_table_protodef_greptime_2fv1_2fmeta_2fregion_2eproto,
...
MigrateRegionRequest::MigrateRegionRequest(const MigrateRegionRequest& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.flush_timeout_secs_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  ::memcpy(&_impl_.region_id_, &from._impl_.region_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.flush_timeout_secs_) -
    reinterpret_cast<char*>(&_impl_.region_id_)) + sizeof(_impl_.flush_timeout_secs_));
...
// @@protoc_insertion_point(message_clear_start:greptime.v1.meta.MigrateRegionRequest)
  ...
  ::memset(&_impl_.region_id_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.flush_timeout_secs_) -
      reinterpret_cast<char*>(&_impl_.region_id_)) + sizeof(_impl_.flush_timeout_secs_));
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          _impl_.flush_timeout_secs_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* MigrateRegionRequest::_InternalSerialize(
  ...
  // uint32 flush_timeout_secs = 7;
  if (this->_internal_flush_timeout_secs() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(7, this->_internal_flush_timeout_secs(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:greptime.v1.meta.MigrateRegionRequest)
  ...
  // uint32 flush_timeout_secs = 7;
  if (this->_internal_flush_timeout_secs() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_flush_timeout_secs());
  }
...
void MigrateRegionRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_flush_timeout_secs() != 0) {
    _this->_internal_set_flush_timeout_secs(from._internal_flush_timeout_secs());
  }
...
void MigrateRegionRequest::InternalSwap(MigrateRegionRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MigrateRegionRequest, _impl_.flush_timeout_secs_)
      + sizeof(MigrateRegionRequest::_impl_.flush_timeout_secs_)
