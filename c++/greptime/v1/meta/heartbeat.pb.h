...
class RegionLease final :
 ...
 public:
  ...
  private:
  uint32_t _internal_region_ids(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      _internal_region_ids() const;
  void _internal_add_region_ids(uint32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      _internal_mutable_region_ids();
  public:
  uint32_t region_ids(int index) const;
  void set_region_ids(int index, uint32_t value);
  void add_region_ids(uint32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      region_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      mutable_region_ids();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t > region_ids_;
...
inline uint32_t RegionLease::_internal_region_ids(int index) const {
  return _impl_.region_ids_.Get(index);
}
inline uint32_t RegionLease::region_ids(int index) const {
  // @@protoc_insertion_point(field_get:greptime.v1.meta.RegionLease.region_ids)
  return _internal_region_ids(index);
}
inline void RegionLease::set_region_ids(int index, uint32_t value) {
  _impl_.region_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:greptime.v1.meta.RegionLease.region_ids)
}
inline void RegionLease::_internal_add_region_ids(uint32_t value) {
  _impl_.region_ids_.Add(value);
}
inline void RegionLease::add_region_ids(uint32_t value) {
