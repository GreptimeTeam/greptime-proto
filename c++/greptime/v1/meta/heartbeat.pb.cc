...
const uint32_t TableStruct_greptime_2fv1_2fmeta_2fheartbeat_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::greptime::v1::meta::RegionStat, _impl_.state_),
  ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_greptime_2fv1_2fmeta_2fheartbeat_2eproto = {
    false, false, 1484, descriptor_table_protodef_greptime_2fv1_2fmeta_2fheartbeat_2eproto,
...
RegionStat::RegionStat(const RegionStat& from)
  ...
  ::memcpy(&_impl_.region_id_, &from._impl_.region_id_,
    ...
    reinterpret_cast<char*>(&_impl_.region_id_)) + sizeof(_impl_.state_));
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          ...
          CHK_(ptr);
          _internal_set_state(static_cast<::greptime::v1::meta::RegionState>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
void RegionStat::InternalSwap(RegionStat* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(RegionStat, _impl_.state_)
      + sizeof(RegionStat::_impl_.state_)
