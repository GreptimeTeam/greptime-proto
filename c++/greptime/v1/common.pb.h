...
extern ColumnIdDefaultTypeInternal _ColumnId_default_instance_;
...
extern RegionIdDefaultTypeInternal _RegionId_default_instance_;
class RequestHeader;
...
template<> ::greptime::v1::ColumnId* Arena::CreateMaybeMessage<::greptime::v1::ColumnId>(Arena*);
template<> ::greptime::v1::FlightMetadata* Arena::CreateMaybeMessage<::greptime::v1::FlightMetadata>(Arena*);
template<> ::greptime::v1::RegionId* Arena::CreateMaybeMessage<::greptime::v1::RegionId>(Arena*);
...
class ColumnId final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:greptime.v1.ColumnId) */ {
 public:
  inline ColumnId() : ColumnId(nullptr) {}
  ~ColumnId() override;
  explicit PROTOBUF_CONSTEXPR ColumnId(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ColumnId(const ColumnId& from);
  ColumnId(ColumnId&& from) noexcept
    : ColumnId() {
    *this = ::std::move(from);
  }
  ...
  inline ColumnId& operator=(ColumnId&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static inline const ColumnId* internal_default_instance() {
    return reinterpret_cast<const ColumnId*>(
               &_ColumnId_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    9;

  friend void swap(ColumnId& a, ColumnId& b) {
    a.Swap(&b);
  }
  inline void Swap(ColumnId* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ColumnId* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ColumnId* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ColumnId>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ColumnId& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ColumnId& from) {
    ColumnId::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ColumnId* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "greptime.v1.ColumnId";
  }
  protected:
  explicit ColumnId(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class RegionId final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:greptime.v1.RegionId) */ {
 public:
  inline RegionId() : RegionId(nullptr) {}
  ~RegionId() override;
  explicit PROTOBUF_CONSTEXPR RegionId(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  RegionId(const RegionId& from);
  RegionId(RegionId&& from) noexcept
    : RegionId() {
    *this = ::std::move(from);
  }

  inline RegionId& operator=(const RegionId& from) {
    CopyFrom(from);
    return *this;
  }
  inline RegionId& operator=(RegionId&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const RegionId& default_instance() {
    return *internal_default_instance();
  }
  static inline const RegionId* internal_default_instance() {
    return reinterpret_cast<const RegionId*>(
               &_RegionId_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(RegionId& a, RegionId& b) {
    a.Swap(&b);
  }
  inline void Swap(RegionId* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(RegionId* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  RegionId* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<RegionId>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const RegionId& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const RegionId& from) {
    RegionId::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RegionId* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "greptime.v1.RegionId";
  }
  protected:
  explicit RegionId(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
// uint32 column_id = 1;
inline void ColumnId::clear_column_id() {
  _impl_.column_id_ = 0u;
}
inline uint32_t ColumnId::_internal_column_id() const {
  return _impl_.column_id_;
}
inline uint32_t ColumnId::column_id() const {
  // @@protoc_insertion_point(field_get:greptime.v1.ColumnId.column_id)
  return _internal_column_id();
}
inline void ColumnId::_internal_set_column_id(uint32_t value) {
  
  _impl_.column_id_ = value;
}
inline void ColumnId::set_column_id(uint32_t value) {
  _internal_set_column_id(value);
  // @@protoc_insertion_point(field_set:greptime.v1.ColumnId.column_id)
}
...
// uint64 region_id = 1;
inline void RegionId::clear_region_id() {
  _impl_.region_id_ = uint64_t{0u};
}
inline uint64_t RegionId::_internal_region_id() const {
  return _impl_.region_id_;
}
inline uint64_t RegionId::region_id() const {
  // @@protoc_insertion_point(field_get:greptime.v1.RegionId.region_id)
  return _internal_region_id();
}
inline void RegionId::_internal_set_region_id(uint64_t value) {
  
  _impl_.region_id_ = value;
}
inline void RegionId::set_region_id(uint64_t value) {
  _internal_set_region_id(value);
  // @@protoc_insertion_point(field_set:greptime.v1.RegionId.region_id)
}
