...
PROTOBUF_CONSTEXPR JsonTypeExtension::JsonTypeExtension(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.is_json_)*/false
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct JsonTypeExtensionDefaultTypeInternal {
  PROTOBUF_CONSTEXPR JsonTypeExtensionDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~JsonTypeExtensionDefaultTypeInternal() {}
  union {
    JsonTypeExtension _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 JsonTypeExtensionDefaultTypeInternal _JsonTypeExtension_default_instance_;
...
const uint32_t TableStruct_greptime_2fv1_2fcommon_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::greptime::v1::JsonTypeExtension, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::greptime::v1::JsonTypeExtension, _impl_.is_json_),
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 154, -1, -1, sizeof(::greptime::v1::JsonTypeExtension)},
  { 161, 169, -1, sizeof(::greptime::v1::ColumnOptions_OptionsEntry_DoNotUse)},
  { 171, -1, -1, sizeof(::greptime::v1::ColumnOptions)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::greptime::v1::_JsonTypeExtension_default_instance_._instance,
...
class ColumnDataTypeExtension::_Internal {
 public:
  ...
  static const ::greptime::v1::JsonTypeExtension& json_type(const ColumnDataTypeExtension* msg);
};
...
const ::greptime::v1::JsonTypeExtension&
ColumnDataTypeExtension::_Internal::json_type(const ColumnDataTypeExtension* msg) {
  return *msg->_impl_.type_ext_.json_type_;
}
...
void ColumnDataTypeExtension::set_allocated_json_type(::greptime::v1::JsonTypeExtension* json_type) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  clear_type_ext();
  if (json_type) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(json_type);
    if (message_arena != submessage_arena) {
      json_type = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, json_type, submessage_arena);
    }
    set_has_json_type();
    _impl_.type_ext_.json_type_ = json_type;
  }
  // @@protoc_insertion_point(field_set_allocated:greptime.v1.ColumnDataTypeExtension.json_type)
}
...
ColumnDataTypeExtension::ColumnDataTypeExtension(const ColumnDataTypeExtension& from)
  ...
  switch (from.type_ext_case()) {
    ...
    case kJsonType: {
      _this->_internal_mutable_json_type()->::greptime::v1::JsonTypeExtension::MergeFrom(
          from._internal_json_type());
      break;
    }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ptr = ctx->ParseMessage(_internal_mutable_json_type(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ColumnDataTypeExtension::_InternalSerialize(
  ...
  if (_internal_has_json_type()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, _Internal::json_type(this),
        _Internal::json_type(this).GetCachedSize(), target, stream);
  }
...
class JsonTypeExtension::_Internal {
 public:
};

JsonTypeExtension::JsonTypeExtension(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:greptime.v1.JsonTypeExtension)
}
JsonTypeExtension::JsonTypeExtension(const JsonTypeExtension& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  JsonTypeExtension* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.is_json_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _this->_impl_.is_json_ = from._impl_.is_json_;
  // @@protoc_insertion_point(copy_constructor:greptime.v1.JsonTypeExtension)
}

inline void JsonTypeExtension::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
JsonTypeExtension::~JsonTypeExtension() {
  // @@protoc_insertion_point(destructor:greptime.v1.JsonTypeExtension)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void JsonTypeExtension::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void JsonTypeExtension::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void JsonTypeExtension::Clear() {
// @@protoc_insertion_point(message_clear_start:greptime.v1.JsonTypeExtension)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* JsonTypeExtension::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _impl_.is_json_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* JsonTypeExtension::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:greptime.v1.JsonTypeExtension)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  // bool is_json = 1;
  if (this->_internal_is_json() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(1, this->_internal_is_json(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:greptime.v1.JsonTypeExtension)
  return target;
}

size_t JsonTypeExtension::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:greptime.v1.JsonTypeExtension)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData JsonTypeExtension::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    JsonTypeExtension::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*JsonTypeExtension::GetClassData() const { return &_class_data_; }


void JsonTypeExtension::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<JsonTypeExtension*>(&to_msg);
  auto& from = static_cast<const JsonTypeExtension&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:greptime.v1.JsonTypeExtension)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (from._internal_is_json() != 0) {
    _this->_internal_set_is_json(from._internal_is_json());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}

void JsonTypeExtension::CopyFrom(const JsonTypeExtension& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:greptime.v1.JsonTypeExtension)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool JsonTypeExtension::IsInitialized() const {
  return true;
}

void JsonTypeExtension::InternalSwap(JsonTypeExtension* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.is_json_, other->_impl_.is_json_);
}

::PROTOBUF_NAMESPACE_ID::Metadata JsonTypeExtension::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_greptime_2fv1_2fcommon_2eproto_getter, &descriptor_table_greptime_2fv1_2fcommon_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::greptime::v1::JsonTypeExtension*
Arena::CreateMaybeMessage< ::greptime::v1::JsonTypeExtension >(Arena* arena) {
  return Arena::CreateMessageInternal< ::greptime::v1::JsonTypeExtension >(arena);
}
