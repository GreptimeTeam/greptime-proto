...
const uint32_t TableStruct_greptime_2fv1_2fcommon_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::greptime::v1::QueryContext, _impl_.source_),
...
const ::_pbi::DescriptorTable descriptor_table_greptime_2fv1_2fcommon_2eproto = {
    false, false, 2066, descriptor_table_protodef_greptime_2fv1_2fcommon_2eproto,
...
uint8_t* QueryContext::_InternalSerialize(
  ...
  if (this->_internal_source() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(6, this->_internal_source(), target);
  }
