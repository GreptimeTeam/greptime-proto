...
PROTOBUF_CONSTEXPR RegionMutation::RegionMutation(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.mutations_)*/{}
  , /*decltype(_impl_.region_id_)*/uint64_t{0u}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct RegionMutationDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RegionMutationDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~RegionMutationDefaultTypeInternal() {}
  union {
    RegionMutation _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RegionMutationDefaultTypeInternal _RegionMutation_default_instance_;
PROTOBUF_CONSTEXPR WalEntry::WalEntry(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.region_mutations_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
static ::_pb::Metadata file_level_metadata_greptime_2fv1_2fmito_2fwal_2eproto[3];
...
const uint32_t TableStruct_greptime_2fv1_2fmito_2fwal_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::greptime::v1::mito::RegionMutation, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::greptime::v1::mito::RegionMutation, _impl_.region_id_),
  PROTOBUF_FIELD_OFFSET(::greptime::v1::mito::RegionMutation, _impl_.mutations_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::greptime::v1::mito::WalEntry, _impl_.region_mutations_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::greptime::v1::mito::Mutation)},
  { 9, -1, -1, sizeof(::greptime::v1::mito::RegionMutation)},
  { 17, -1, -1, sizeof(::greptime::v1::mito::WalEntry)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::greptime::v1::mito::_Mutation_default_instance_._instance,
  &::greptime::v1::mito::_RegionMutation_default_instance_._instance,
...
class RegionMutation::_Internal {
 public:
};

RegionMutation::RegionMutation(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:greptime.v1.mito.RegionMutation)
}
RegionMutation::RegionMutation(const RegionMutation& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RegionMutation* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:greptime.v1.mito.RegionMutation)
}

inline void RegionMutation::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
RegionMutation::~RegionMutation() {
  // @@protoc_insertion_point(destructor:greptime.v1.mito.RegionMutation)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void RegionMutation::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.mutations_.~RepeatedPtrField();
}

void RegionMutation::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void RegionMutation::Clear() {
// @@protoc_insertion_point(message_clear_start:greptime.v1.mito.RegionMutation)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* RegionMutation::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* RegionMutation::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:greptime.v1.mito.RegionMutation)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:greptime.v1.mito.RegionMutation)
  return target;
}

size_t RegionMutation::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:greptime.v1.mito.RegionMutation)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RegionMutation::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    RegionMutation::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*RegionMutation::GetClassData() const { return &_class_data_; }


void RegionMutation::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RegionMutation*>(&to_msg);
  auto& from = static_cast<const RegionMutation&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:greptime.v1.mito.RegionMutation)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void RegionMutation::CopyFrom(const RegionMutation& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:greptime.v1.mito.RegionMutation)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RegionMutation::IsInitialized() const {
  return true;
}

void RegionMutation::InternalSwap(RegionMutation* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata RegionMutation::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_greptime_2fv1_2fmito_2fwal_2eproto_getter, &descriptor_table_greptime_2fv1_2fmito_2fwal_2eproto_once,
...
WalEntry::WalEntry(const WalEntry& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.region_mutations_){from._impl_.region_mutations_}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void WalEntry::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.region_mutations_){arena}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void WalEntry::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.region_mutations_.~RepeatedPtrField();
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_region_mutations(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
uint8_t* WalEntry::_InternalSerialize(
  ...
  // repeated .greptime.v1.mito.RegionMutation region_mutations = 1;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_region_mutations_size()); i < n; i++) {
    const auto& repfield = this->_internal_region_mutations(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:greptime.v1.mito.WalEntry)
  ...
  // repeated .greptime.v1.mito.RegionMutation region_mutations = 1;
  total_size += 1UL * this->_internal_region_mutations_size();
  for (const auto& msg : this->_impl_.region_mutations_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void WalEntry::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.region_mutations_.MergeFrom(from._impl_.region_mutations_);
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void WalEntry::InternalSwap(WalEntry* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.region_mutations_.InternalSwap(&other->_impl_.region_mutations_);
}

::PROTOBUF_NAMESPACE_ID::Metadata WalEntry::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_greptime_2fv1_2fmito_2fwal_2eproto_getter, &descriptor_table_greptime_2fv1_2fmito_2fwal_2eproto_once,
      file_level_metadata_greptime_2fv1_2fmito_2fwal_2eproto[2]);
}
...
template<> PROTOBUF_NOINLINE ::greptime::v1::mito::RegionMutation*
Arena::CreateMaybeMessage< ::greptime::v1::mito::RegionMutation >(Arena* arena) {
  return Arena::CreateMessageInternal< ::greptime::v1::mito::RegionMutation >(arena);
}
