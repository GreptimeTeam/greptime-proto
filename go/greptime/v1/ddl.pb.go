...
func (x *FlowPartitionId) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FlowPartitionId) ProtoMessage() {}

func (x *FlowPartitionId) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_ddl_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FlowPartitionId.ProtoReflect.Descriptor instead.
func (*FlowPartitionId) Descriptor() ([]byte, []int) {
	return file_greptime_v1_ddl_proto_rawDescGZIP(), []int{20}
}

func (x *FlowPartitionId) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_greptime_v1_ddl_proto_rawDesc = []byte{
	...
	0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x22, 0x9d, 0x02, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0xc4, 0x01, 0x0a, 0x0c, 0x44, 0x72, 0x6f, 0x70, 0x56,
	...
	0x46, 0x6c, 0x6f, 0x77, 0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12,
...
var file_greptime_v1_ddl_proto_goTypes = []interface{}{
	...
	(*FlowPartitionId)(nil),             // 21: greptime.v1.FlowPartitionId
...
var file_greptime_v1_ddl_proto_depIdxs = []int32{
	...
	26, // 24: greptime.v1.CreateDatabaseExpr.options:type_name -> greptime.v1.CreateDatabaseExpr.OptionsEntry
	...
	22, // 29: greptime.v1.AddColumn.column_def:type_name -> greptime.v1.ColumnDef
	23, // 30: greptime.v1.AddColumn.location:type_name -> greptime.v1.AddColumnLocation
	29, // 31: greptime.v1.ChangeColumnType.target_type:type_name -> greptime.v1.ColumnDataType
	30, // 32: greptime.v1.ChangeColumnType.target_type_extension:type_name -> greptime.v1.ColumnDataTypeExtension
	29, // 33: greptime.v1.ColumnDef.data_type:type_name -> greptime.v1.ColumnDataType
	31, // 34: greptime.v1.ColumnDef.semantic_type:type_name -> greptime.v1.SemanticType
	30, // 35: greptime.v1.ColumnDef.datatype_extension:type_name -> greptime.v1.ColumnDataTypeExtension
	0,  // 36: greptime.v1.AddColumnLocation.location_type:type_name -> greptime.v1.AddColumnLocation.LocationType
