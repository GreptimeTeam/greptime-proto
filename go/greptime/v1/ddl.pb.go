...
func (x *ModifyColumn) GetDataType() ColumnDataType {
	if x != nil {
		return x.DataType
	}
...
var file_greptime_v1_ddl_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x7f, 0x0a, 0x0c, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x79,
	...
	0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x44,
	0x65, 0x66, 0x52, 0x09, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x44, 0x65, 0x66, 0x12, 0x38, 0x0a,
	...
	0x61, 0x74, 0x61, 0x54, 0x79, 0x70, 0x65, 0x22, 0x20, 0x0a, 0x0a, 0x44, 0x72, 0x6f, 0x70, 0x43,
...
var file_greptime_v1_ddl_proto_goTypes = []interface{}{
	...
	(SemanticType)(0),                   // 21: greptime.v1.SemanticType
...
var file_greptime_v1_ddl_proto_depIdxs = []int32{
	...
	20, // 21: greptime.v1.ModifyColumn.data_type:type_name -> greptime.v1.ColumnDataType
	20, // 22: greptime.v1.ColumnDef.data_type:type_name -> greptime.v1.ColumnDataType
	21, // 23: greptime.v1.ColumnDef.semantic_type:type_name -> greptime.v1.SemanticType
	22, // 24: greptime.v1.ColumnDef.datatype_extension:type_name -> greptime.v1.ColumnDataTypeExtension
