...
type AlterDatabaseTasks struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Tasks []*v1.AlterDatabaseExpr `protobuf:"bytes,1,rep,name=tasks,proto3" json:"tasks,omitempty"`
}

func (x *AlterDatabaseTasks) Reset() {
	*x = AlterDatabaseTasks{}
	if protoimpl.UnsafeEnabled {
...
func (x *AlterDatabaseTasks) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AlterDatabaseTasks) ProtoMessage() {}

func (x *AlterDatabaseTasks) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_meta_ddl_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AlterDatabaseTasks.ProtoReflect.Descriptor instead.
func (*AlterDatabaseTasks) Descriptor() ([]byte, []int) {
	return file_greptime_v1_meta_ddl_proto_rawDescGZIP(), []int{13}
}

func (x *AlterDatabaseTasks) GetTasks() []*v1.AlterDatabaseExpr {
	if x != nil {
		return x.Tasks
	}
	return nil
...
type DdlTaskRequest struct {
	...
	//	*DdlTaskRequest_AlterDatabaseTasks
...
func (x *DdlTaskRequest) GetAlterDatabaseTasks() *AlterDatabaseTasks {
	if x, ok := x.GetTask().(*DdlTaskRequest_AlterDatabaseTasks); ok {
		return x.AlterDatabaseTasks
	}
	return nil
}
...
type DdlTaskRequest_AlterDatabaseTasks struct {
	AlterDatabaseTasks *AlterDatabaseTasks `protobuf:"bytes,15,opt,name=alter_database_tasks,json=alterDatabaseTasks,proto3,oneof"`
}
...
func (*DdlTaskRequest_AlterDatabaseTasks) isDdlTaskRequest_Task() {}
...
var file_greptime_v1_meta_ddl_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x08, 0x64, 0x72, 0x6f, 0x70, 0x56, 0x69, 0x65, 0x77, 0x22, 0x4a, 0x0a, 0x12, 0x41,
	0x6c, 0x74, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x54, 0x61, 0x73, 0x6b,
	0x73, 0x12, 0x34, 0x0a, 0x05, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	...
	0x52, 0x05, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x22, 0xf9, 0x09, 0x0a, 0x0e, 0x44, 0x64, 0x6c, 0x54,
	...
	0x64, 0x65, 0x72, 0x12, 0x3e, 0x0a, 0x0d, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x63, 0x6f, 0x6e,
	0x74, 0x65, 0x78, 0x74, 0x18, 0x40, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x72, 0x65,
	...
	0x65, 0x78, 0x74, 0x12, 0x4f, 0x0a, 0x11, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x61,
	...
	0x6b, 0x12, 0x58, 0x0a, 0x14, 0x61, 0x6c, 0x74, 0x65, 0x72, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x62,
	0x61, 0x73, 0x65, 0x5f, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x54, 0x61, 0x73, 0x6b, 0x73, 0x48, 0x00, 0x52, 0x12, 0x61, 0x6c, 0x74, 0x65, 0x72, 0x44, 0x61,
	0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x73, 0x42, 0x06, 0x0a, 0x04, 0x74,
...
var file_greptime_v1_meta_ddl_proto_goTypes = []interface{}{
	...
	(*AlterDatabaseTasks)(nil),    // 14: greptime.v1.meta.AlterDatabaseTasks
...
var file_greptime_v1_meta_ddl_proto_depIdxs = []int32{
	...
	28, // 14: greptime.v1.meta.AlterDatabaseTasks.tasks:type_name -> greptime.v1.AlterDatabaseExpr
	...
	14, // 30: greptime.v1.meta.DdlTaskRequest.alter_database_tasks:type_name -> greptime.v1.meta.AlterDatabaseTasks
...
func file_greptime_v1_meta_ddl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greptime_v1_meta_ddl_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AlterDatabaseTasks); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_greptime_v1_meta_ddl_proto_msgTypes[14].OneofWrappers = []interface{}{
		...
		(*DdlTaskRequest_AlterDatabaseTasks)(nil),
	}
	type x struct{}
