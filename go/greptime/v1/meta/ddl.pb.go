...
func (x *SubmitDdlTaskRequest) GetHeader() *ResponseHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
type SumbitDdlTaskResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SumbitDdlTaskResponse) Reset() {
	*x = SumbitDdlTaskResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SumbitDdlTaskResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SumbitDdlTaskResponse) ProtoMessage() {}

func (x *SumbitDdlTaskResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_meta_ddl_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SumbitDdlTaskResponse.ProtoReflect.Descriptor instead.
func (*SumbitDdlTaskResponse) Descriptor() ([]byte, []int) {
	return file_greptime_v1_meta_ddl_proto_rawDescGZIP(), []int{2}
}

func (x *SumbitDdlTaskResponse) GetHeader() *ResponseHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *SumbitDdlTaskResponse) GetKey() []byte {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *SumbitDdlTaskResponse) GetStatus() Status {
	if x != nil {
		return x.Status
	}
	return Status_Done
...
var file_greptime_v1_meta_ddl_proto_rawDesc = []byte{
	...
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xe5, 0x01, 0x0a, 0x14, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74,
	0x44, 0x64, 0x6c, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x38,
	...
	0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x62, 0x6a,
	...
	0x73, 0x12, 0x2a, 0x0a, 0x04, 0x74, 0x61, 0x73, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x16, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x6d, 0x65,
	0x74, 0x61, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x04, 0x74, 0x61, 0x73, 0x6b, 0x22, 0x95, 0x01,
	0x0a, 0x15, 0x53, 0x75, 0x6d, 0x62, 0x69, 0x74, 0x44, 0x64, 0x6c, 0x54, 0x61, 0x73, 0x6b, 0x52,
	...
	,
	...
	0x31, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x53, 0x75, 0x6d, 0x62, 0x69, 0x74, 0x44, 0x64, 0x6c,
...
var file_greptime_v1_meta_ddl_proto_goTypes = []interface{}{
	...
	(*SumbitDdlTaskResponse)(nil), // 4: greptime.v1.meta.SumbitDdlTaskResponse
...
var file_greptime_v1_meta_ddl_proto_depIdxs = []int32{
	...
	5, // 1: greptime.v1.meta.SubmitDdlTaskRequest.header:type_name -> greptime.v1.meta.ResponseHeader
	2, // 2: greptime.v1.meta.SubmitDdlTaskRequest.task:type_name -> greptime.v1.meta.Task
	5, // 3: greptime.v1.meta.SumbitDdlTaskResponse.header:type_name -> greptime.v1.meta.ResponseHeader
	1, // 4: greptime.v1.meta.SumbitDdlTaskResponse.status:type_name -> greptime.v1.meta.Status
	3, // 5: greptime.v1.meta.DdlTask.SubmitDdlTask:input_type -> greptime.v1.meta.SubmitDdlTaskRequest
	4, // 6: greptime.v1.meta.DdlTask.SubmitDdlTask:output_type -> greptime.v1.meta.SumbitDdlTaskResponse
...
func file_greptime_v1_meta_ddl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greptime_v1_meta_ddl_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SumbitDdlTaskResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
