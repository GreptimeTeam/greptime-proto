...
type Region struct {
	...
	PartitionExpr string `protobuf:"bytes,4,opt,name=partition_expr,json=partitionExpr,proto3" json:"partition_expr,omitempty"`
}
...
func (x *Region) GetPartitionExpr() string {
	if x != nil {
...
var file_greptime_v1_meta_route_proto_rawDesc = []byte{
	...
	0x87, 0x02, 0x0a, 0x06, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x72, 0x79, 0x52, 0x05, 0x61, 0x74, 0x74, 0x72, 0x73, 0x12, 0x3d, 0x0a, 0x09, 0x70, 0x61, 0x72,
	...
	0x50, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x02, 0x18, 0x01, 0x52, 0x09, 0x70,
	0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x25, 0x0a, 0x0e, 0x70, 0x61, 0x72, 0x74,
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x65, 0x78, 0x70, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0d, 0x70, 0x61, 0x72, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x78, 0x70, 0x72, 0x1a,
...
var file_greptime_v1_meta_route_proto_depIdxs = []int32{
	...
	6, // 4: greptime.v1.meta.Region.attrs:type_name -> greptime.v1.meta.Region.AttrsEntry
	4, // 5: greptime.v1.meta.Region.partition:type_name -> greptime.v1.meta.Partition
