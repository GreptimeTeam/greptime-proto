...
type RegionLease struct {
	...
	CloseableRegionIds uint64           `protobuf:"varint,4,opt,name=closeable_region_ids,json=closeableRegionIds,proto3" json:"closeable_region_ids,omitempty"`
}
...
var file_greptime_v1_meta_heartbeat_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x12, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x61, 0x62, 0x6c,
