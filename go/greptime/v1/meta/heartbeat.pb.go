...
type DatanodeWorkloadType int32

const (
	// / The datanode can handle all workloads (both ingest and query).
	DatanodeWorkloadType_HYBRID DatanodeWorkloadType = 0
	// / The datanode can only handle ingest workloads.
	DatanodeWorkloadType_INGEST DatanodeWorkloadType = 1
	// / The datanode can only handle query workloads.
	DatanodeWorkloadType_QUERY DatanodeWorkloadType = 2
)

// Enum value maps for DatanodeWorkloadType.
var (
	DatanodeWorkloadType_name = map[int32]string{
		0: "HYBRID",
		1: "INGEST",
		2: "QUERY",
	}
	DatanodeWorkloadType_value = map[string]int32{
		"HYBRID": 0,
		"INGEST": 1,
		"QUERY":  2,
	}
...
func (x DatanodeWorkloadType) Enum() *DatanodeWorkloadType {
	p := new(DatanodeWorkloadType)
	*p = x
	return p
}

func (x DatanodeWorkloadType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DatanodeWorkloadType) Descriptor() protoreflect.EnumDescriptor {
	return file_greptime_v1_meta_heartbeat_proto_enumTypes[0].Descriptor()
}

func (DatanodeWorkloadType) Type() protoreflect.EnumType {
	return &file_greptime_v1_meta_heartbeat_proto_enumTypes[0]
}

func (x DatanodeWorkloadType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DatanodeWorkloadType.Descriptor instead.
func (DatanodeWorkloadType) EnumDescriptor() ([]byte, []int) {
	return file_greptime_v1_meta_heartbeat_proto_rawDescGZIP(), []int{0}
}

// / The workload type of the frontend.
type FrontendWorkloadType int32

const (
	// / The frontend can handle all workloads.
	FrontendWorkloadType_FRONTEND_DEFAULT FrontendWorkloadType = 0
)

// Enum value maps for FrontendWorkloadType.
var (
	FrontendWorkloadType_name = map[int32]string{
		0: "FRONTEND_DEFAULT",
	}
	FrontendWorkloadType_value = map[string]int32{
		"FRONTEND_DEFAULT": 0,
	}
)

func (x FrontendWorkloadType) Enum() *FrontendWorkloadType {
	p := new(FrontendWorkloadType)
	*p = x
	return p
}

func (x FrontendWorkloadType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FrontendWorkloadType) Descriptor() protoreflect.EnumDescriptor {
	return file_greptime_v1_meta_heartbeat_proto_enumTypes[1].Descriptor()
}

func (FrontendWorkloadType) Type() protoreflect.EnumType {
	return &file_greptime_v1_meta_heartbeat_proto_enumTypes[1]
}

func (x FrontendWorkloadType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FrontendWorkloadType.Descriptor instead.
func (FrontendWorkloadType) EnumDescriptor() ([]byte, []int) {
	return file_greptime_v1_meta_heartbeat_proto_rawDescGZIP(), []int{1}
}

// / The workload type of the flownode.
type FlownodeWorkloadType int32

const (
	// / The flownode can handle all workloads.
	FlownodeWorkloadType_FLOWNODE_DEFAULT FlownodeWorkloadType = 0
)

// Enum value maps for FlownodeWorkloadType.
var (
	FlownodeWorkloadType_name = map[int32]string{
		0: "FLOWNODE_DEFAULT",
	}
	FlownodeWorkloadType_value = map[string]int32{
		"FLOWNODE_DEFAULT": 0,
	}
)

func (x FlownodeWorkloadType) Enum() *FlownodeWorkloadType {
	p := new(FlownodeWorkloadType)
	*p = x
	return p
}

func (x FlownodeWorkloadType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FlownodeWorkloadType) Descriptor() protoreflect.EnumDescriptor {
	return file_greptime_v1_meta_heartbeat_proto_enumTypes[2].Descriptor()
}

func (FlownodeWorkloadType) Type() protoreflect.EnumType {
	return &file_greptime_v1_meta_heartbeat_proto_enumTypes[2]
}

func (x FlownodeWorkloadType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FlownodeWorkloadType.Descriptor instead.
func (FlownodeWorkloadType) EnumDescriptor() ([]byte, []int) {
...
func (RegionRole) Descriptor() protoreflect.EnumDescriptor {
	return file_greptime_v1_meta_heartbeat_proto_enumTypes[3].Descriptor()
}

func (RegionRole) Type() protoreflect.EnumType {
	return &file_greptime_v1_meta_heartbeat_proto_enumTypes[3]
}
...
type DatanodeWorkloads struct {
	...
	Types []DatanodeWorkloadType `protobuf:"varint,1,rep,packed,name=types,proto3,enum=greptime.v1.meta.DatanodeWorkloadType" json:"types,omitempty"`
}
...
func (x *DatanodeWorkloads) GetTypes() []DatanodeWorkloadType {
	if x != nil {
		return x.Types
	}
	return nil
...
type FrontendWorkloads struct {
	...
	Types []FrontendWorkloadType `protobuf:"varint,1,rep,packed,name=types,proto3,enum=greptime.v1.meta.FrontendWorkloadType" json:"types,omitempty"`
}
...
func (x *FrontendWorkloads) GetTypes() []FrontendWorkloadType {
	if x != nil {
		return x.Types
	}
	return nil
...
type FlownodeWorkloads struct {
	...
	Types []FlownodeWorkloadType `protobuf:"varint,1,rep,packed,name=types,proto3,enum=greptime.v1.meta.FlownodeWorkloadType" json:"types,omitempty"`
}
...
func (x *FlownodeWorkloads) GetTypes() []FlownodeWorkloadType {
	if x != nil {
		return x.Types
	}
	return nil
...
var file_greptime_v1_meta_heartbeat_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x38, 0x01, 0x1a, 0x46, 0x0a, 0x18, 0x46, 0x6c, 0x6f, 0x77, 0x4c, 0x61, 0x73, 0x74, 0x45, 0x78,
	0x65, 0x63, 0x54, 0x69, 0x6d, 0x65, 0x4d, 0x61, 0x70, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10,
	0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x6b, 0x65, 0x79,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xda, 0x01, 0x0a, 0x11, 0x48,
	...
	,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd1, 0x01, 0x0a, 0x0b, 0x52, 0x65, 0x67,
	0x69, 0x6f, 0x6e, 0x4c, 0x65, 0x61, 0x73, 0x65, 0x12, 0x39, 0x0a, 0x07, 0x72, 0x65, 0x67, 0x69,
	0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x67, 0x72, 0x65, 0x70,
	0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x47, 0x72, 0x61,
	0x6e, 0x74, 0x65, 0x64, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x72, 0x65, 0x67, 0x69,
	0x6f, 0x6e, 0x73, 0x12, 0x30, 0x0a, 0x14, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	...
	0x61, 0x73, 0x65, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x30, 0x0a, 0x14, 0x63, 0x6c,
	0x6f, 0x73, 0x65, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x5f, 0x69,
	0x64, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x04, 0x52, 0x12, 0x63, 0x6c, 0x6f, 0x73, 0x65, 0x61,
	0x62, 0x6c, 0x65, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x73, 0x22, 0x4b, 0x0a, 0x10,
	...
	,
...
var file_greptime_v1_meta_heartbeat_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_greptime_v1_meta_heartbeat_proto_goTypes = []interface{}{
	(DatanodeWorkloadType)(0), // 0: greptime.v1.meta.DatanodeWorkloadType
	(FrontendWorkloadType)(0), // 1: greptime.v1.meta.FrontendWorkloadType
	(FlownodeWorkloadType)(0), // 2: greptime.v1.meta.FlownodeWorkloadType
	(RegionRole)(0),           // 3: greptime.v1.meta.RegionRole
	(*HeartbeatRequest)(nil),  // 4: greptime.v1.meta.HeartbeatRequest
	(*DatanodeWorkloads)(nil), // 5: greptime.v1.meta.DatanodeWorkloads
	(*FrontendWorkloads)(nil), // 6: greptime.v1.meta.FrontendWorkloads
	(*FlownodeWorkloads)(nil), // 7: greptime.v1.meta.FlownodeWorkloads
	(*NodeInfo)(nil),          // 8: greptime.v1.meta.NodeInfo
	(*RegionStat)(nil),        // 9: greptime.v1.meta.RegionStat
	(*FlowStat)(nil),          // 10: greptime.v1.meta.FlowStat
	(*HeartbeatResponse)(nil), // 11: greptime.v1.meta.HeartbeatResponse
	(*GrantedRegion)(nil),     // 12: greptime.v1.meta.GrantedRegion
	(*RegionLease)(nil),       // 13: greptime.v1.meta.RegionLease
	(*AskLeaderRequest)(nil),  // 14: greptime.v1.meta.AskLeaderRequest
	(*AskLeaderResponse)(nil), // 15: greptime.v1.meta.AskLeaderResponse
	(*MailboxMessage)(nil),    // 16: greptime.v1.meta.MailboxMessage
...
var file_greptime_v1_meta_heartbeat_proto_depIdxs = []int32{
	...
	9,  // 3: greptime.v1.meta.HeartbeatRequest.region_stats:type_name -> greptime.v1.meta.RegionStat
	16, // 4: greptime.v1.meta.HeartbeatRequest.mailbox_message:type_name -> greptime.v1.meta.MailboxMessage
	8,  // 5: greptime.v1.meta.HeartbeatRequest.info:type_name -> greptime.v1.meta.NodeInfo
	10, // 6: greptime.v1.meta.HeartbeatRequest.flow_stat:type_name -> greptime.v1.meta.FlowStat
	5,  // 7: greptime.v1.meta.HeartbeatRequest.datanode:type_name -> greptime.v1.meta.DatanodeWorkloads
	6,  // 8: greptime.v1.meta.HeartbeatRequest.frontend:type_name -> greptime.v1.meta.FrontendWorkloads
	7,  // 9: greptime.v1.meta.HeartbeatRequest.flownode:type_name -> greptime.v1.meta.FlownodeWorkloads
	0,  // 10: greptime.v1.meta.DatanodeWorkloads.types:type_name -> greptime.v1.meta.DatanodeWorkloadType
	1,  // 11: greptime.v1.meta.FrontendWorkloads.types:type_name -> greptime.v1.meta.FrontendWorkloadType
	2,  // 12: greptime.v1.meta.FlownodeWorkloads.types:type_name -> greptime.v1.meta.FlownodeWorkloadType
	3,  // 13: greptime.v1.meta.RegionStat.role:type_name -> greptime.v1.meta.RegionRole
	17, // 14: greptime.v1.meta.RegionStat.extensions:type_name -> greptime.v1.meta.RegionStat.ExtensionsEntry
	18, // 15: greptime.v1.meta.FlowStat.flow_stat_size:type_name -> greptime.v1.meta.FlowStat.FlowStatSizeEntry
	19, // 16: greptime.v1.meta.FlowStat.flow_last_exec_time_map:type_name -> greptime.v1.meta.FlowStat.FlowLastExecTimeMapEntry
	24, // 17: greptime.v1.meta.HeartbeatResponse.header:type_name -> greptime.v1.meta.ResponseHeader
	16, // 18: greptime.v1.meta.HeartbeatResponse.mailbox_message:type_name -> greptime.v1.meta.MailboxMessage
	13, // 19: greptime.v1.meta.HeartbeatResponse.region_lease:type_name -> greptime.v1.meta.RegionLease
	3,  // 20: greptime.v1.meta.GrantedRegion.role:type_name -> greptime.v1.meta.RegionRole
	20, // 21: greptime.v1.meta.GrantedRegion.extensions:type_name -> greptime.v1.meta.GrantedRegion.ExtensionsEntry
	12, // 22: greptime.v1.meta.RegionLease.regions:type_name -> greptime.v1.meta.GrantedRegion
	...
	4,  // 26: greptime.v1.meta.Heartbeat.Heartbeat:input_type -> greptime.v1.meta.HeartbeatRequest
	14, // 27: greptime.v1.meta.Heartbeat.AskLeader:input_type -> greptime.v1.meta.AskLeaderRequest
	11, // 28: greptime.v1.meta.Heartbeat.Heartbeat:output_type -> greptime.v1.meta.HeartbeatResponse
	15, // 29: greptime.v1.meta.Heartbeat.AskLeader:output_type -> greptime.v1.meta.AskLeaderResponse
