...
type FlowStat struct {
	...
	FlowStatSize map[uint64]uint64 `protobuf:"bytes,1,rep,name=flow_stat_size,json=flowStatSize,proto3" json:"flow_stat_size,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *FlowStat) GetFlowStatSize() map[uint64]uint64 {
	if x != nil {
...
var file_greptime_v1_meta_heartbeat_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x4d, 0x73, 0x22, 0xd5, 0x02, 0x0a, 0x0a, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e,
	...
	0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x9f, 0x01,
