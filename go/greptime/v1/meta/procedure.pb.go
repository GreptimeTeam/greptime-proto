...
func (x *GcRegionsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GcRegionsRequest) ProtoMessage() {}

func (x *GcRegionsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_meta_procedure_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GcRegionsRequest.ProtoReflect.Descriptor instead.
func (*GcRegionsRequest) Descriptor() ([]byte, []int) {
	return file_greptime_v1_meta_procedure_proto_rawDescGZIP(), []int{10}
}

func (x *GcRegionsRequest) GetHeader() *RequestHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *GcRegionsRequest) GetRegionIds() []uint64 {
	if x != nil {
		return x.RegionIds
	}
	return nil
...
func (x *GcRegionsRequest) GetFullFileListing() bool {
	if x != nil {
		return x.FullFileListing
	}
	return false
}

func (x *GcRegionsRequest) GetTimeoutSecs() uint32 {
	if x != nil {
...
func (x *GcRegionsRequest) GetEventContext() *ProcedureEventContext {
	if x != nil {
...
func (x *GcRegionsRequest) GetActor() *ProcedureActor {
	if x != nil {
		return x.Actor
	}
	return nil
...
type GcStats struct {
	...
	ProcessedRegions uint64 `protobuf:"varint,1,opt,name=processed_regions,json=processedRegions,proto3" json:"processed_regions,omitempty"`
	// Regions that need retry in the next GC round.
	NeedRetryRegions []uint64 `protobuf:"varint,2,rep,packed,name=need_retry_regions,json=needRetryRegions,proto3" json:"need_retry_regions,omitempty"`
	// Number of deleted SST files.
	DeletedFiles uint64 `protobuf:"varint,3,opt,name=deleted_files,json=deletedFiles,proto3" json:"deleted_files,omitempty"`
	// Number of deleted index files.
	DeletedIndexes uint64 `protobuf:"varint,4,opt,name=deleted_indexes,json=deletedIndexes,proto3" json:"deleted_indexes,omitempty"`
}
...
func (x *GcStats) GetProcessedRegions() uint64 {
	if x != nil {
		return x.ProcessedRegions
	}
	return 0
}

func (x *GcStats) GetNeedRetryRegions() []uint64 {
	if x != nil {
		return x.NeedRetryRegions
	}
	return nil
}

func (x *GcStats) GetDeletedFiles() uint64 {
	if x != nil {
...
type GcRegionsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Header *ResponseHeader `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
	Stats  *GcStats        `protobuf:"bytes,2,opt,name=stats,proto3" json:"stats,omitempty"`
}

func (x *GcRegionsResponse) Reset() {
	*x = GcRegionsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GcRegionsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GcRegionsResponse) ProtoMessage() {}

func (x *GcRegionsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_meta_procedure_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GcRegionsResponse.ProtoReflect.Descriptor instead.
func (*GcRegionsResponse) Descriptor() ([]byte, []int) {
	return file_greptime_v1_meta_procedure_proto_rawDescGZIP(), []int{12}
}

func (x *GcRegionsResponse) GetHeader() *ResponseHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *GcRegionsResponse) GetStats() *GcStats {
	if x != nil {
		return x.Stats
	}
	return nil
...
func (x *GcTableRequest) Reset() {
	*x = GcTableRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_greptime_v1_meta_procedure_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GcTableRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GcTableRequest) ProtoMessage() {}

func (x *GcTableRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_meta_procedure_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GcTableRequest.ProtoReflect.Descriptor instead.
func (*GcTableRequest) Descriptor() ([]byte, []int) {
	return file_greptime_v1_meta_procedure_proto_rawDescGZIP(), []int{13}
}

func (x *GcTableRequest) GetHeader() *RequestHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *GcTableRequest) GetCatalogName() string {
	if x != nil {
		return x.CatalogName
	}
	return ""
...
func (x *GcTableRequest) GetSchemaName() string {
	if x != nil {
		return x.SchemaName
	}
	return ""
...
func (x *GcTableRequest) GetTableName() string {
	if x != nil {
		return x.TableName
	}
	return ""
...
func (x *GcTableRequest) GetFullFileListing() bool {
	if x != nil {
		return x.FullFileListing
	}
	return false
...
func (x *GcTableRequest) GetTimeoutSecs() uint32 {
	if x != nil {
		return x.TimeoutSecs
	}
	return 0
...
func (x *GcTableRequest) GetEventContext() *ProcedureEventContext {
	if x != nil {
		return x.EventContext
	}
	return nil
...
func (x *GcTableRequest) GetActor() *ProcedureActor {
	if x != nil {
		return x.Actor
	}
	return nil
...
func (x *GcTableResponse) Reset() {
	*x = GcTableResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_greptime_v1_meta_procedure_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *GcTableResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GcTableResponse) ProtoMessage() {}

func (x *GcTableResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_meta_procedure_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GcTableResponse.ProtoReflect.Descriptor instead.
func (*GcTableResponse) Descriptor() ([]byte, []int) {
	return file_greptime_v1_meta_procedure_proto_rawDescGZIP(), []int{14}
}

func (x *GcTableResponse) GetHeader() *ResponseHeader {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *GcTableResponse) GetStats() *GcStats {
	if x != nil {
		return x.Stats
	}
	return nil
...
var file_greptime_v1_meta_procedure_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x65, 0x49, 0x64, 0x52, 0x03, 0x70, 0x69, 0x64, 0x22, 0xbf, 0x02, 0x0a, 0x10, 0x47,
	0x63, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	,
	...
	0x12, 0x2f, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x19, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x6d, 0x65,
	0x74, 0x61, 0x2e, 0x47, 0x63, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74,
	0x73, 0x22, 0x81, 0x03, 0x0a, 0x0e, 0x47, 0x63, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65, 0x71,
	...
	,
	...
	,
	...
	,
...
var file_greptime_v1_meta_procedure_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_greptime_v1_meta_procedure_proto_goTypes = []interface{}{
	...
	(*GcRegionsRequest)(nil),        // 12: greptime.v1.meta.GcRegionsRequest
	(*GcStats)(nil),                 // 13: greptime.v1.meta.GcStats
	(*GcRegionsResponse)(nil),       // 14: greptime.v1.meta.GcRegionsResponse
	(*GcTableRequest)(nil),          // 15: greptime.v1.meta.GcTableRequest
	(*GcTableResponse)(nil),         // 16: greptime.v1.meta.GcTableResponse
	(*ProcedureId)(nil),             // 17: greptime.v1.meta.ProcedureId
	(*RequestHeader)(nil),           // 18: greptime.v1.meta.RequestHeader
	(*ResponseHeader)(nil),          // 19: greptime.v1.meta.ResponseHeader
	(*ProcedureEventContext)(nil),   // 20: greptime.v1.meta.ProcedureEventContext
	(*ProcedureActor)(nil),          // 21: greptime.v1.meta.ProcedureActor
	(*DdlTaskRequest)(nil),          // 22: greptime.v1.meta.DdlTaskRequest
	(*MigrateRegionRequest)(nil),    // 23: greptime.v1.meta.MigrateRegionRequest
	(*DdlTaskResponse)(nil),         // 24: greptime.v1.meta.DdlTaskResponse
	(*MigrateRegionResponse)(nil),   // 25: greptime.v1.meta.MigrateRegionResponse
}
var file_greptime_v1_meta_procedure_proto_depIdxs = []int32{
	17, // 0: greptime.v1.meta.ProcedureMeta.id:type_name -> greptime.v1.meta.ProcedureId
	0,  // 1: greptime.v1.meta.ProcedureMeta.status:type_name -> greptime.v1.meta.ProcedureStatus
	18, // 2: greptime.v1.meta.QueryProcedureRequest.header:type_name -> greptime.v1.meta.RequestHeader
	17, // 3: greptime.v1.meta.QueryProcedureRequest.pid:type_name -> greptime.v1.meta.ProcedureId
	19, // 4: greptime.v1.meta.ProcedureStateResponse.header:type_name -> greptime.v1.meta.ResponseHeader
	0,  // 5: greptime.v1.meta.ProcedureStateResponse.status:type_name -> greptime.v1.meta.ProcedureStatus
	18, // 6: greptime.v1.meta.ProcedureDetailRequest.header:type_name -> greptime.v1.meta.RequestHeader
	19, // 7: greptime.v1.meta.ProcedureDetailResponse.header:type_name -> greptime.v1.meta.ResponseHeader
	...
	18, // 12: greptime.v1.meta.ReconcileRequest.header:type_name -> greptime.v1.meta.RequestHeader
	...
	19, // 16: greptime.v1.meta.ReconcileResponse.header:type_name -> greptime.v1.meta.ResponseHeader
	17, // 17: greptime.v1.meta.ReconcileResponse.pid:type_name -> greptime.v1.meta.ProcedureId
	18, // 18: greptime.v1.meta.GcRegionsRequest.header:type_name -> greptime.v1.meta.RequestHeader
	20, // 19: greptime.v1.meta.GcRegionsRequest.event_context:type_name -> greptime.v1.meta.ProcedureEventContext
	21, // 20: greptime.v1.meta.GcRegionsRequest.actor:type_name -> greptime.v1.meta.ProcedureActor
	19, // 21: greptime.v1.meta.GcRegionsResponse.header:type_name -> greptime.v1.meta.ResponseHeader
	13, // 22: greptime.v1.meta.GcRegionsResponse.stats:type_name -> greptime.v1.meta.GcStats
	18, // 23: greptime.v1.meta.GcTableRequest.header:type_name -> greptime.v1.meta.RequestHeader
	20, // 24: greptime.v1.meta.GcTableRequest.event_context:type_name -> greptime.v1.meta.ProcedureEventContext
	21, // 25: greptime.v1.meta.GcTableRequest.actor:type_name -> greptime.v1.meta.ProcedureActor
	19, // 26: greptime.v1.meta.GcTableResponse.header:type_name -> greptime.v1.meta.ResponseHeader
	13, // 27: greptime.v1.meta.GcTableResponse.stats:type_name -> greptime.v1.meta.GcStats
	3,  // 28: greptime.v1.meta.ProcedureService.query:input_type -> greptime.v1.meta.QueryProcedureRequest
	22, // 29: greptime.v1.meta.ProcedureService.ddl:input_type -> greptime.v1.meta.DdlTaskRequest
	10, // 30: greptime.v1.meta.ProcedureService.reconcile:input_type -> greptime.v1.meta.ReconcileRequest
	23, // 31: greptime.v1.meta.ProcedureService.migrate:input_type -> greptime.v1.meta.MigrateRegionRequest
	5,  // 32: greptime.v1.meta.ProcedureService.details:input_type -> greptime.v1.meta.ProcedureDetailRequest
	12, // 33: greptime.v1.meta.ProcedureService.gc_regions:input_type -> greptime.v1.meta.GcRegionsRequest
	15, // 34: greptime.v1.meta.ProcedureService.gc_table:input_type -> greptime.v1.meta.GcTableRequest
	4,  // 35: greptime.v1.meta.ProcedureService.query:output_type -> greptime.v1.meta.ProcedureStateResponse
	24, // 36: greptime.v1.meta.ProcedureService.ddl:output_type -> greptime.v1.meta.DdlTaskResponse
	11, // 37: greptime.v1.meta.ProcedureService.reconcile:output_type -> greptime.v1.meta.ReconcileResponse
	25, // 38: greptime.v1.meta.ProcedureService.migrate:output_type -> greptime.v1.meta.MigrateRegionResponse
	6,  // 39: greptime.v1.meta.ProcedureService.details:output_type -> greptime.v1.meta.ProcedureDetailResponse
	14, // 40: greptime.v1.meta.ProcedureService.gc_regions:output_type -> greptime.v1.meta.GcRegionsResponse
	16, // 41: greptime.v1.meta.ProcedureService.gc_table:output_type -> greptime.v1.meta.GcTableResponse
...
func file_greptime_v1_meta_procedure_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greptime_v1_meta_procedure_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GcRegionsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_greptime_v1_meta_procedure_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GcTableRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_greptime_v1_meta_procedure_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GcTableResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
