...
var file_greptime_v1_meta_cluster_proto_rawDesc = []byte{
	...
	0xb6, 0x01, 0x0a, 0x14, 0x4d, 0x65, 0x74, 0x61, 0x73, 0x72, 0x76, 0x50, 0x65, 0x65, 0x72, 0x73,
	...
	0x65, 0x72, 0x12, 0x34, 0x0a, 0x09, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x73, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65,
	0x2e, 0x76, 0x31, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x52, 0x09, 0x66,
	0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x73, 0x32, 0x85, 0x02, 0x0a, 0x07, 0x43, 0x6c, 0x75,
...
var file_greptime_v1_meta_cluster_proto_goTypes = []interface{}{
	...
	(*BatchGetRequest)(nil),      // 5: greptime.v1.meta.BatchGetRequest
	(*RangeRequest)(nil),         // 6: greptime.v1.meta.RangeRequest
	(*BatchGetResponse)(nil),     // 7: greptime.v1.meta.BatchGetResponse
	(*RangeResponse)(nil),        // 8: greptime.v1.meta.RangeResponse
}
var file_greptime_v1_meta_cluster_proto_depIdxs = []int32{
	2, // 0: greptime.v1.meta.MetasrvPeersRequest.header:type_name -> greptime.v1.meta.RequestHeader
	3, // 1: greptime.v1.meta.MetasrvPeersResponse.header:type_name -> greptime.v1.meta.ResponseHeader
	4, // 2: greptime.v1.meta.MetasrvPeersResponse.leader:type_name -> greptime.v1.meta.Peer
	4, // 3: greptime.v1.meta.MetasrvPeersResponse.followers:type_name -> greptime.v1.meta.Peer
	5, // 4: greptime.v1.meta.Cluster.BatchGet:input_type -> greptime.v1.meta.BatchGetRequest
	6, // 5: greptime.v1.meta.Cluster.Range:input_type -> greptime.v1.meta.RangeRequest
	0, // 6: greptime.v1.meta.Cluster.MetasrvPeers:input_type -> greptime.v1.meta.MetasrvPeersRequest
	7, // 7: greptime.v1.meta.Cluster.BatchGet:output_type -> greptime.v1.meta.BatchGetResponse
	8, // 8: greptime.v1.meta.Cluster.Range:output_type -> greptime.v1.meta.RangeResponse
	1, // 9: greptime.v1.meta.Cluster.MetasrvPeers:output_type -> greptime.v1.meta.MetasrvPeersResponse
