...
type MetasrvNodeInfo struct {
	...
	Addr      *Peer  `protobuf:"bytes,1,opt,name=addr,proto3" json:"addr,omitempty"`
...
func (x *MetasrvNodeInfo) GetAddr() *Peer {
	if x != nil {
		return x.Addr
	}
	return nil
...
var file_greptime_v1_meta_cluster_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x2a, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x16, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x6d, 0x65,
	0x74, 0x61, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x52, 0x04, 0x61, 0x64, 0x64, 0x72, 0x12, 0x18, 0x0a,
...
var file_greptime_v1_meta_cluster_proto_depIdxs = []int32{
	...
	5, // 4: greptime.v1.meta.MetasrvNodeInfo.addr:type_name -> greptime.v1.meta.Peer
