...
func (x *GreptimeRequest) GetKill() *KillRequest {
	if x, ok := x.GetRequest().(*GreptimeRequest_Kill); ok {
		return x.Kill
	}
	return nil
}
...
type GreptimeRequest_Kill struct {
	Kill *KillRequest `protobuf:"bytes,8,opt,name=kill,proto3,oneof"`
}
...
func (*GreptimeRequest_Kill) isGreptimeRequest_Request() {}
...
func (x *KillRequest) GetProcessId() uint64 {
	if x != nil {
		return x.ProcessId
	}
	return 0
...
func (x *KillRequest) GetServerAddr() string {
	if x != nil {
		return x.ServerAddr
	}
	return ""
...
var file_greptime_v1_database_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xd8, 0x03, 0x0a, 0x0f, 0x47, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65,
	...
	0x74, 0x65, 0x73, 0x12, 0x2e, 0x0a, 0x04, 0x6b, 0x69, 0x6c, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x18, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e,
	0x4b, 0x69, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x04, 0x6b,
	0x69, 0x6c, 0x6c, 0x42, 0x09, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x95,
	...
	0x77, 0x73, 0x22, 0x4d, 0x0a, 0x0b, 0x4b, 0x69, 0x6c, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x49, 0x64,
	...
	0x72, 0x32, 0xaa, 0x01, 0x0a, 0x10, 0x47, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x44, 0x61,
	0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x45, 0x0a, 0x06, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65,
	...
	,
...
var file_greptime_v1_database_proto_goTypes = []interface{}{
	...
	(*KillRequest)(nil),       // 11: greptime.v1.KillRequest
...
var file_greptime_v1_database_proto_depIdxs = []int32{
	...
	11, // 7: greptime.v1.GreptimeRequest.kill:type_name -> greptime.v1.KillRequest
	14, // 8: greptime.v1.GreptimeResponse.header:type_name -> greptime.v1.ResponseHeader
	15, // 9: greptime.v1.GreptimeResponse.affected_rows:type_name -> greptime.v1.AffectedRows
	16, // 10: greptime.v1.QueryRequest.prom_range_query:type_name -> greptime.v1.PromRangeQuery
	4,  // 11: greptime.v1.InsertRequests.inserts:type_name -> greptime.v1.InsertRequest
	17, // 12: greptime.v1.InsertRequest.columns:type_name -> greptime.v1.Column
	6,  // 13: greptime.v1.DeleteRequests.deletes:type_name -> greptime.v1.DeleteRequest
	17, // 14: greptime.v1.DeleteRequest.key_columns:type_name -> greptime.v1.Column
	8,  // 15: greptime.v1.RowInsertRequests.inserts:type_name -> greptime.v1.RowInsertRequest
	18, // 16: greptime.v1.RowInsertRequest.rows:type_name -> greptime.v1.Rows
	10, // 17: greptime.v1.RowDeleteRequests.deletes:type_name -> greptime.v1.RowDeleteRequest
