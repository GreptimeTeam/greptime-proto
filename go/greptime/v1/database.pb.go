...
var file_greptime_v1_database_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xe2, 0x02, 0x0a, 0x0f, 0x47, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65,
	...
	0x00, 0x52, 0x0a, 0x72, 0x6f, 0x77, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x73, 0x42, 0x09, 0x0a,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x42, 0x51, 0x0a, 0x0e, 0x69, 0x6f, 0x2e,
	0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x08, 0x44, 0x61, 0x74,
	0x61, 0x62, 0x61, 0x73, 0x65, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_greptime_v1_database_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_greptime_v1_database_proto_goTypes = []interface{}{
	...
	(*RequestHeader)(nil),     // 8: greptime.v1.RequestHeader
	(*DdlRequest)(nil),        // 9: greptime.v1.DdlRequest
	(*ResponseHeader)(nil),    // 10: greptime.v1.ResponseHeader
	(*AffectedRows)(nil),      // 11: greptime.v1.AffectedRows
	(*PromRangeQuery)(nil),    // 12: greptime.v1.PromRangeQuery
	(*Column)(nil),            // 13: greptime.v1.Column
	(*Rows)(nil),              // 14: greptime.v1.Rows
}
var file_greptime_v1_database_proto_depIdxs = []int32{
	8,  // 0: greptime.v1.GreptimeRequest.header:type_name -> greptime.v1.RequestHeader
	...
	9,  // 3: greptime.v1.GreptimeRequest.ddl:type_name -> greptime.v1.DdlRequest
	...
	10, // 6: greptime.v1.GreptimeResponse.header:type_name -> greptime.v1.ResponseHeader
	11, // 7: greptime.v1.GreptimeResponse.affected_rows:type_name -> greptime.v1.AffectedRows
	12, // 8: greptime.v1.QueryRequest.prom_range_query:type_name -> greptime.v1.PromRangeQuery
	...
	13, // 11: greptime.v1.DeleteRequest.key_columns:type_name -> greptime.v1.Column
	7,  // 12: greptime.v1.RowInsertRequests.inserts:type_name -> greptime.v1.RowInsertRequest
	14, // 13: greptime.v1.RowInsertRequest.rows:type_name -> greptime.v1.Rows
	0,  // 14: greptime.v1.GreptimeDatabase.Handle:input_type -> greptime.v1.GreptimeRequest
	0,  // 15: greptime.v1.GreptimeDatabase.HandleRequests:input_type -> greptime.v1.GreptimeRequest
	1,  // 16: greptime.v1.GreptimeDatabase.Handle:output_type -> greptime.v1.GreptimeResponse
	1,  // 17: greptime.v1.GreptimeDatabase.HandleRequests:output_type -> greptime.v1.GreptimeResponse
