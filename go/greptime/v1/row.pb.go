...
func (x *ColumnSchema) GetOptions() map[string]string {
	if x != nil {
		return x.Options
	}
	return nil
...
var file_greptime_v1_row_proto_rawDesc = []byte{
	...
	0xfb, 0x02, 0x0a, 0x0c, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61,
	...
	0x40, 0x0a, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x26, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43,
	0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x4f, 0x70, 0x74, 0x69,
	...
	0x74, 0x61, 0x42, 0x50, 0x0a, 0x0e, 0x69, 0x6f, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d,
...
var file_greptime_v1_row_proto_goTypes = []interface{}{
	...
	nil,                             // 4: greptime.v1.ColumnSchema.OptionsEntry
	(ColumnDataType)(0),             // 5: greptime.v1.ColumnDataType
	(SemanticType)(0),               // 6: greptime.v1.SemanticType
	(*ColumnDataTypeExtension)(nil), // 7: greptime.v1.ColumnDataTypeExtension
...
var file_greptime_v1_row_proto_depIdxs = []int32{
	...
	5, // 2: greptime.v1.ColumnSchema.datatype:type_name -> greptime.v1.ColumnDataType
	6, // 3: greptime.v1.ColumnSchema.semantic_type:type_name -> greptime.v1.SemanticType
	7, // 4: greptime.v1.ColumnSchema.datatype_extension:type_name -> greptime.v1.ColumnDataTypeExtension
	4, // 5: greptime.v1.ColumnSchema.options:type_name -> greptime.v1.ColumnSchema.OptionsEntry
