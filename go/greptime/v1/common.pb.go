...
type ColumnDataTypeExtension_JsonType struct {
	...
	JsonType *JsonTypeExtension `protobuf:"bytes,2,opt,name=json_type,json=jsonType,proto3,oneof"`
}
...
type JsonTypeExtension struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	IsJson bool `protobuf:"varint,1,opt,name=is_json,json=isJson,proto3" json:"is_json,omitempty"`
}

func (x *JsonTypeExtension) Reset() {
	*x = JsonTypeExtension{}
	if protoimpl.UnsafeEnabled {
...
func (*JsonTypeExtension) ProtoMessage() {}

func (x *JsonTypeExtension) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_common_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JsonTypeExtension.ProtoReflect.Descriptor instead.
func (*JsonTypeExtension) Descriptor() ([]byte, []int) {
	return file_greptime_v1_common_proto_rawDescGZIP(), []int{16}
}

func (x *JsonTypeExtension) GetIsJson() bool {
	if x != nil {
		return x.IsJson
	}
	return false
...
var file_greptime_v1_common_proto_rawDesc = []byte{
	...
	0x73, 0x63, 0x61, 0x6c, 0x65, 0x22, 0x2c, 0x0a, 0x11, 0x4a, 0x73, 0x6f, 0x6e, 0x54, 0x79, 0x70,
	0x65, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x73,
	0x5f, 0x6a, 0x73, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69, 0x73, 0x4a,
	0x73, 0x6f, 0x6e, 0x22, 0x8e, 0x01, 0x0a, 0x0d, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x4f, 0x70,
...
var file_greptime_v1_common_proto_goTypes = []interface{}{
	...
	(*JsonTypeExtension)(nil),       // 18: greptime.v1.JsonTypeExtension
...
var file_greptime_v1_common_proto_depIdxs = []int32{
	...
	18, // 9: greptime.v1.ColumnDataTypeExtension.json_type:type_name -> greptime.v1.JsonTypeExtension
...
func file_greptime_v1_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greptime_v1_common_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JsonTypeExtension); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
