...
type QueryContext struct {
	...
	SeqSnapshot    *SequenceSnapshot `protobuf:"bytes,7,opt,name=seq_snapshot,json=seqSnapshot,proto3" json:"seq_snapshot,omitempty"`
}
...
func (x *QueryContext) GetSeqSnapshot() *SequenceSnapshot {
	if x != nil {
		return x.SeqSnapshot
	}
	return nil
}
...
type SequenceSnapshot struct {
	...
	SeqSnapshot map[uint64]uint64 `protobuf:"bytes,7,rep,name=seq_snapshot,json=seqSnapshot,proto3" json:"seq_snapshot,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}

func (x *SequenceSnapshot) Reset() {
	*x = SequenceSnapshot{}
	if protoimpl.UnsafeEnabled {
...
func (x *SequenceSnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SequenceSnapshot) ProtoMessage() {}

func (x *SequenceSnapshot) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_common_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SequenceSnapshot.ProtoReflect.Descriptor instead.
func (*SequenceSnapshot) Descriptor() ([]byte, []int) {
	return file_greptime_v1_common_proto_rawDescGZIP(), []int{1}
}

func (x *SequenceSnapshot) GetSeqSnapshot() map[uint64]uint64 {
	if x != nil {
		return x.SeqSnapshot
	}
	return nil
...
var file_greptime_v1_common_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x40, 0x0a, 0x0c, 0x73, 0x65, 0x71,
	0x5f, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x1d, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65,
	0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x52, 0x0b,
	0x73, 0x65, 0x71, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x1a, 0x3d, 0x0a, 0x0f, 0x45,
	...
	0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x12,
	0x51, 0x0a, 0x0c, 0x73, 0x65, 0x71, 0x5f, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x18,
	0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65,
	0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x53, 0x6e, 0x61, 0x70,
	0x73, 0x68, 0x6f, 0x74, 0x2e, 0x53, 0x65, 0x71, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0b, 0x73, 0x65, 0x71, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68,
	0x6f, 0x74, 0x1a, 0x3e, 0x0a, 0x10, 0x53, 0x65, 0x71, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f,
...
var file_greptime_v1_common_proto_goTypes = []interface{}{
	...
	(*SequenceSnapshot)(nil),        // 4: greptime.v1.SequenceSnapshot
	...
	nil,                             // 23: greptime.v1.SequenceSnapshot.SeqSnapshotEntry
...
var file_greptime_v1_common_proto_depIdxs = []int32{
	...
	4,  // 1: greptime.v1.QueryContext.seq_snapshot:type_name -> greptime.v1.SequenceSnapshot
	23, // 2: greptime.v1.SequenceSnapshot.seq_snapshot:type_name -> greptime.v1.SequenceSnapshot.SeqSnapshotEntry
